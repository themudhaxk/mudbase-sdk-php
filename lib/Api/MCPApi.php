...
class MCPApi
{
     ...
     * @return \OpenAPI\Client\Model\McpConfigGet200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\McpConfigGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\McpConfigGet200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\McpConfigGet200Response';
        $request = $this->mcpConfigGetRequest($contentType);
