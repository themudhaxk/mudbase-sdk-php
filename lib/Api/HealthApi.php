...
class HealthApi
{
     ...
     * @return \OpenAPI\Client\Model\HealthResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HealthResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation healthSystemStatus
     *
     * System status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthSystemStatus'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SystemStatusResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error
     */
    public function healthSystemStatus(string $contentType = self::contentTypes['healthSystemStatus'][0])
    {
        list($response) = $this->healthSystemStatusWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation healthSystemStatusWithHttpInfo
     *
     * System status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthSystemStatus'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SystemStatusResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function healthSystemStatusWithHttpInfo(string $contentType = self::contentTypes['healthSystemStatus'][0])
    {
        $request = $this->healthSystemStatusRequest($contentType);
    ...
    /**
     * Operation healthSystemStatusAsync
     *
     * System status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthSystemStatus'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function healthSystemStatusAsync(string $contentType = self::contentTypes['healthSystemStatus'][0])
    {
        return $this->healthSystemStatusAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation healthSystemStatusAsyncWithHttpInfo
     *
     * System status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthSystemStatus'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function healthSystemStatusAsyncWithHttpInfo(string $contentType = self::contentTypes['healthSystemStatus'][0])
    {
    ...
    /**
     * Create request for operation 'healthSystemStatus'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['healthSystemStatus'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function healthSystemStatusRequest(string $contentType = self::contentTypes['healthSystemStatus'][0])
    {
