...
class HealthApi
{
     ...
     * @return \MudbaseSDK\Model\HealthResponse
     */
     ...
     * @throws \MudbaseSDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MudbaseSDK\Model\HealthResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\MudbaseSDK\Model\HealthResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\MudbaseSDK\Model\HealthResponse';
        $request = $this->healthCheckRequest($contentType);
     ...
     * @throws \MudbaseSDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MudbaseSDK\Model\SystemStatusResponse
     */
     ...
     * @throws \MudbaseSDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MudbaseSDK\Model\SystemStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function systemStatusWithHttpInfo(string $contentType = self::contentTypes['systemStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\MudbaseSDK\Model\SystemStatusResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\MudbaseSDK\Model\SystemStatusResponse';
        $request = $this->systemStatusRequest($contentType);
