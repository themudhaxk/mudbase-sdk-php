...
/**
 * AuthRefreshRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthRefreshRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_refresh_request';
    ...
    */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token The refresh token returned from login/sign-in (org or project)
     *
     * @return self
     */
