...
/**
 * TwoFASetupResponse Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class TwoFASetupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwoFASetupResponse';
    ...
    */
    ...
    public function setManualEntryKey($manual_entry_key)
    {
        if (is_null($manual_entry_key)) {
            throw new \InvalidArgumentException('non-nullable manual_entry_key cannot be null');
        }
