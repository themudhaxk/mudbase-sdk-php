...
/**
 * MarkMessagesAsRead200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class MarkMessagesAsRead200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'markMessagesAsRead_200_response_data';
    ...
    protected static $setters = [
        'modified_count' => 'setModifiedCount'
    ];
    ...
    protected static $getters = [
        'modified_count' => 'getModifiedCount'
    ];
    ...
    {
        $this->setIfExists('modified_count', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['modified_count'];
    }

    /**
     * Sets modified_count
     *
     * @param int|null $modified_count modified_count
     *
     * @return self
     */
    public function setModifiedCount($modified_count)
    {
        if (is_null($modified_count)) {
            throw new \InvalidArgumentException('non-nullable modified_count cannot be null');
        }
        $this->container['modified_count'] = $modified_count;
