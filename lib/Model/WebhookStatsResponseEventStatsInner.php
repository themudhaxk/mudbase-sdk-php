...
/**
 * WebhookStatsResponseEventStatsInner Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebhookStatsResponseEventStatsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookStatsResponse_eventStats_inner';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Event name
     *
     * @return self
     */
     ...
     * Sets success_rate
     *
     * @param float|null $success_rate Fraction of logs with status success (0–1)
     *
     * @return self
     */
