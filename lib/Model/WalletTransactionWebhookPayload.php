...
/**
 * WalletTransactionWebhookPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class WalletTransactionWebhookPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletTransactionWebhookPayload';
    ...
    */
     ...
     * Sets data
     *
     * @param object|null $data Payload data (addressId, address, chain, txHash, transaction, etc.)
     *
     * @return self
     */
