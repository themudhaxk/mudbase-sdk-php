...
/**
 * GetScannerMetrics200ResponseMetricsValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetScannerMetrics200ResponseMetricsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getScannerMetrics_200_response_metrics_value';
    ...
    protected static $setters = [
        'last_scanned_block' => 'setLastScannedBlock',
    ...
    protected static $getters = [
        'last_scanned_block' => 'getLastScannedBlock',
    ...
    {
        $this->setIfExists('last_scanned_block', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets last_scanned_block
     *
     * @return float|null
     */
    public function getLastScannedBlock()
    {
        return $this->container['last_scanned_block'];
    }

    /**
     * Sets last_scanned_block
     *
     * @param float|null $last_scanned_block last_scanned_block
     *
     * @return self
     */
    public function setLastScannedBlock($last_scanned_block)
    {
        if (is_null($last_scanned_block)) {
            array_push($this->openAPINullablesSetToNull, 'last_scanned_block');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_scanned_block', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['last_scanned_block'] = $last_scanned_block;
     ...
     * Sets current_block
     *
     * @param float|null $current_block current_block
     *
     * @return self
     */
    public function setCurrentBlock($current_block)
    {
        if (is_null($current_block)) {
            array_push($this->openAPINullablesSetToNull, 'current_block');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('current_block', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
