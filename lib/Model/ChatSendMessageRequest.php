...
class ChatSendMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'content' => 'string',
        'e2ee' => '\OpenAPI\Client\Model\ChatSendMessageRequestE2ee',
        'reply_to' => 'string',
        'mentions' => 'string[]'
    ];
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content Plaintext body; omit when sending e2ee (use e2ee.ciphertext for E2EE text).
     *
     * @return self
     */
     ...
     * Gets e2ee
     *
     * @return \OpenAPI\Client\Model\ChatSendMessageRequestE2ee|null
     */
     ...
     * Sets e2ee
     *
     * @param \OpenAPI\Client\Model\ChatSendMessageRequestE2ee|null $e2ee e2ee
     *
     * @return self
     */
