...
/**
 * RecordUsageRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class RecordUsageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recordUsage_request';
    ...
    */
     ...
     * Sets metric
     *
     * @param string $metric Usage metric name (e.g. api_calls, storage_mb)
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity to record
     *
     * @return self
     */
