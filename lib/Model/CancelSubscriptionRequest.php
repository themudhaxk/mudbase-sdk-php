...
class CancelSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cancelSubscription_request';
    ...
    {
        $this->setIfExists('cancel_immediately', $data ?? [], false);
    }
    ...
    */
     ...
     *
     * @param bool|null $cancel_immediately If true, cancel immediately; otherwise at period end
     *
     * @return self
     */
    public function setCancelImmediately($cancel_immediately)
    {
        if (is_null($cancel_immediately)) {
            throw new \InvalidArgumentException('non-nullable cancel_immediately cannot be null');
        }
