...
/**
 * TestWebhookTransformation200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class TestWebhookTransformation200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'testWebhookTransformation_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transformed', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets original
     *
     * @param object|null $original original
     *
     * @return self
     */
     ...
     * Sets transformed
     *
     * @param object|null $transformed transformed
     *
     * @return self
     */
    public function setTransformed($transformed)
    {
        if (is_null($transformed)) {
            throw new \InvalidArgumentException('non-nullable transformed cannot be null');
        }
