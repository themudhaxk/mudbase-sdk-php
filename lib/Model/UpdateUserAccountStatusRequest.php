...
/**
 * UpdateUserAccountStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateUserAccountStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateUserAccountStatus_request';
    ...
    */
     ...
     * Sets account_status
     *
     * @param string $account_status active = full access; suspended = blocked from using the app
     *
     * @return self
     */
