...
/**
 * AdminApproveOrgDomainCnameRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class AdminApproveOrgDomainCnameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdminApproveOrgDomainCnameRequest';
    ...
    {
        $this->setIfExists('verify_dns', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getVerifyDns()
    {
        return $this->container['verify_dns'];
    }

    /**
     * Sets verify_dns
     *
     * @param bool|null $verify_dns When true, public DNS CNAME chain for hostname must match Fly `dns_requirements.cname` when stored, else `CUSTOM_DOMAIN_API_CNAME_TARGET`.
     *
     * @return self
     */
    public function setVerifyDns($verify_dns)
    {
        if (is_null($verify_dns)) {
            throw new \InvalidArgumentException('non-nullable verify_dns cannot be null');
        }
        $this->container['verify_dns'] = $verify_dns;
