...
class UpdateProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets logo_url
     *
     * @param string|null $logo_url Public URL for the project logo/brand image. Prefer uploading via **POST /api/projects/{id}/logo** (stored under logo/project/ in platform storage). Used in project-related emails.
     *
     * @return self
     */
