...
/**
 * UpdateCollectionPermissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCollectionPermissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCollectionPermissions_request';
    ...
    */
     ...
     * Sets data_scope
     *
     * @param string|null $data_scope `all` = no automatic row-owner filter. `own` = only documents where the owner field matches the authenticated app user.
     *
     * @return self
     */
     ...
     * Sets owner_field
     *
     * @param string|null $owner_field Optional override for the document field when dataScope is `own` (default `settings.dataOwnerField`, usually `createdBy`).
     *
     * @return self
     */
