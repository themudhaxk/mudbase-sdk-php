...
/**
 * InitializePaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class InitializePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initializePayment_request';
    ...
    protected static $openAPITypes = [
        ...
        'currency' => 'string',
        'project_id' => 'string',
        'customer' => '\MudbaseSDK\Model\InitializePaymentRequestCustomer',
        'metadata' => 'object'
    ];
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Payment amount (e.g. USD)
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InitializePaymentRequest., must be bigger than or equal to 0.01.');
        }
     ...
     * Sets project_id
     *
     * @param string|null $project_id Optional project scope
     *
     * @return self
     */
     ...
     * Gets customer
     *
     * @return \MudbaseSDK\Model\InitializePaymentRequestCustomer
     */
     ...
     * Sets customer
     *
     * @param \MudbaseSDK\Model\InitializePaymentRequestCustomer $customer customer
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata title, description, redirectUrl, etc.
     *
     * @return self
     */
