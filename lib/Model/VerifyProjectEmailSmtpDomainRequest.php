...
/**
 * VerifyProjectEmailSmtpDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class VerifyProjectEmailSmtpDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'verifyProjectEmailSmtpDomain_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('persist', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets persist
     *
     * @param bool|null $persist If true and checks pass, persist domainVerifiedAt on the project
     *
     * @return self
     */
    ...
    {
        if (is_null($persist)) {
            throw new \InvalidArgumentException('non-nullable persist cannot be null');
        }
