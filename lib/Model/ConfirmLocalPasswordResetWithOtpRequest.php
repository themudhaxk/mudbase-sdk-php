...
/**
 * ConfirmLocalPasswordResetWithOtpRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmLocalPasswordResetWithOtpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'confirmLocalPasswordResetWithOtp_request';
    ...
    */
    ...
    public function setOtp($otp)
    {
        ...
        if ((mb_strlen($otp) > 6)) {
            throw new \InvalidArgumentException('invalid length for $otp when calling ConfirmLocalPasswordResetWithOtpRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($otp) < 6)) {
            throw new \InvalidArgumentException('invalid length for $otp when calling ConfirmLocalPasswordResetWithOtpRequest., must be bigger than or equal to 6.');
        }
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($otp)))) {
            throw new \InvalidArgumentException("invalid value for \$otp when calling ConfirmLocalPasswordResetWithOtpRequest., must conform to the pattern /^[0-9]+$/.");
        }
    ...
    public function setNewPassword($new_password)
    {
        ...
        if ((mb_strlen($new_password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling ConfirmLocalPasswordResetWithOtpRequest., must be bigger than or equal to 8.');
        }
