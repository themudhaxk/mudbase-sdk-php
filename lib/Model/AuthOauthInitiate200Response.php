...
/**
 * AuthOauthInitiate200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthOauthInitiate200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_oauthInitiate_200_response';
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url OAuth provider authorization URL (when not using 302)
     *
     * @return self
     */
