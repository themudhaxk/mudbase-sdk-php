...
class CreateApiKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets permissions
     *
     * @param \OpenAPI\Client\Model\ApiKeyPermission[]|null $permissions Optional. Permission objects (resource + actions). Omit or pass [] for full access (all resources and actions). Include only the entries you want; remove resources or actions to restrict the key.
     *
     * @return self
     */
