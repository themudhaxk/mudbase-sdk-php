...
class CreateApiKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'project_id' => 'string',
        'permissions' => '\MudbaseSDK\Model\ApiKeyPermission[]',
        'rate_limit' => '\MudbaseSDK\Model\RateLimit',
        'expires_at' => '\DateTime'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9a-fA-F]{24}$/", $this->container['project_id'])) {
            $invalidProperties[] = "invalid value for 'project_id', must be conform to the pattern /^[0-9a-fA-F]{24}$/.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateApiKeyRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateApiKeyRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets project_id
     *
     * @param string $project_id MongoDB ObjectId of the project
     *
     * @return self
     */
    public function setProjectId($project_id)
    {
        ...
        if ((!preg_match("/^[0-9a-fA-F]{24}$/", ObjectSerializer::toString($project_id)))) {
            throw new \InvalidArgumentException("invalid value for \$project_id when calling CreateApiKeyRequest., must conform to the pattern /^[0-9a-fA-F]{24}$/.");
        }
     ...
     * Gets permissions
     *
     * @return \MudbaseSDK\Model\ApiKeyPermission[]|null
     */
     ...
     * Sets permissions
     *
     * @param \MudbaseSDK\Model\ApiKeyPermission[]|null $permissions Optional. Permission objects (resource + actions). Omit or pass [] for full access (all resources and actions). Include only the entries you want; remove resources or actions to restrict the key.
     *
     * @return self
     */
     ...
     * Gets rate_limit
     *
     * @return \MudbaseSDK\Model\RateLimit|null
     */
     ...
     * Sets rate_limit
     *
     * @param \MudbaseSDK\Model\RateLimit|null $rate_limit rate_limit
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Optional. When provided, must be a valid ISO 8601 date-time in the future. Omit for no expiration.
     *
     * @return self
     */
