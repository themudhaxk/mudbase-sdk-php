...
/**
 * PreviewProjectEmailTemplateRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PreviewProjectEmailTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'previewProjectEmailTemplate_request';
    ...
    protected static $openAPITypes = [
        'sample_data' => 'array<string,mixed>'
    ];
    ...
    {
        $this->setIfExists('sample_data', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['sample_data'];
    }

    /**
     * Sets sample_data
     *
     * @param array<string,mixed>|null $sample_data sample_data
     *
     * @return self
     */
    public function setSampleData($sample_data)
    {
        if (is_null($sample_data)) {
            throw new \InvalidArgumentException('non-nullable sample_data cannot be null');
        }
        $this->container['sample_data'] = $sample_data;
