...
/**
 * PatchProjectFcmConfigRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PatchProjectFcmConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchProjectFcmConfig_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_account_json'] === null) {
            $invalidProperties[] = "'service_account_json' can't be null";
        }
        if ($this->container['clear'] === null) {
            $invalidProperties[] = "'clear' can't be null";
        }
     ...
     *
     * @param object $service_account_json Firebase service account JSON (client_email, private_key, etc.)
     *
     * @return self
     */
    ...
    {
        if (is_null($clear)) {
            throw new \InvalidArgumentException('non-nullable clear cannot be null');
        }
