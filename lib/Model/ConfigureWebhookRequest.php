...
/**
 * ConfigureWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ConfigureWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'configureWebhook_request';
    ...
    protected static $openAPITypes = [
        ...
        'transformations' => '\MudbaseSDK\Model\GetWebhookConfig200ResponseDataTransformationsInner[]'
    ];
    ...
    */
     ...
     * Sets webhook_url
     *
     * @param string|null $webhook_url URL to receive webhook payloads; set to null or omit to disable
     *
     * @return self
     */
     ...
     * Sets webhook_secret
     *
     * @param string|null $webhook_secret Optional secret for signing payloads (e.g. X-Webhook-Signature)
     *
     * @return self
     */
     ...
     * Sets webhook_events
     *
     * @param string[]|null $webhook_events Event types to send (e.g. collection.insert, collection.update)
     *
     * @return self
     */
     ...
     *
     * @param string|null $webhook_version Version string for payload format
     *
     * @return self
     */
     ...
     *
     * @return \MudbaseSDK\Model\GetWebhookConfig200ResponseDataTransformationsInner[]|null
     */
     ...
     *
     * @param \MudbaseSDK\Model\GetWebhookConfig200ResponseDataTransformationsInner[]|null $transformations Transformation rules to apply to payloads before delivery
     *
     * @return self
     */
