...
/**
 * GetUserOverview200Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetUserOverview200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getUserOverview_200_response';
    ...
    protected static $openAPITypes = [
        'user' => 'object',
        'footprint' => '\MudbaseSDK\Model\GetUserOverview200ResponseFootprint'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('footprint', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets user
     *
     * @param object|null $user User profile (metadata only)
     *
     * @return self
     */
     ...
     * Gets footprint
     *
     * @return \MudbaseSDK\Model\GetUserOverview200ResponseFootprint|null
     */
     ...
     * Sets footprint
     *
     * @param \MudbaseSDK\Model\GetUserOverview200ResponseFootprint|null $footprint footprint
     *
     * @return self
     */
    public function setFootprint($footprint)
    {
        if (is_null($footprint)) {
            throw new \InvalidArgumentException('non-nullable footprint cannot be null');
        }
