...
/**
 * SignedUrlResponse Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class SignedUrlResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignedUrlResponse';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Signed URL for file access
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Expiration time of the signed URL (optional - some endpoints return expiresIn instead)
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Time-to-live in seconds for the signed URL (optional)
     *
     * @return self
     */
