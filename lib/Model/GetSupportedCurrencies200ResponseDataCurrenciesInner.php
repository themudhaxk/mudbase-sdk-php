...
/**
 * GetSupportedCurrencies200ResponseDataCurrenciesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSupportedCurrencies200ResponseDataCurrenciesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSupportedCurrencies_200_response_data_currencies_inner';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Currency symbol (BTC, ETH, MATIC, BNB, etc.)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Display name (e.g. Bitcoin, Polygon, Arbitrum One)
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string|null $chain Chain id for API use (e.g. ethereum, polygon, arbitrum)
     *
     * @return self
     */
     ...
     * Sets networks
     *
     * @param string[]|null $networks For USDT only; networks on which USDT is supported (ETH, BSC, TRX, SOL, POLYGON)
     *
     * @return self
     */
