...
/**
 * ValidatePasswordResetTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ValidatePasswordResetTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validatePasswordResetToken_request';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Token from the reset link query parameter
     *
     * @return self
     */
