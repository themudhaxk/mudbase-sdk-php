...
/**
 * ApiFilesDownloadFileIdGet200Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiFilesDownloadFileIdGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_files_download__fileId__get_200_response';
    ...
    */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Seconds until the signed URL expires; null for public files.
     *
     * @return self
     */
     ...
     * Sets is_public
     *
     * @param bool|null $is_public Present and true only when the file is public.
     *
     * @return self
     */
     ...
     * Sets warning
     *
     * @param string|null $warning Present only for public files — explains the URL is permanent and unprotected.
     *
     * @return self
     */
