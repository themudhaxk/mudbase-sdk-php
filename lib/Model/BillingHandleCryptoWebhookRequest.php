...
/**
 * BillingHandleCryptoWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BillingHandleCryptoWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billing_handleCryptoWebhook_request';
    ...
    protected static $openAPITypes = [
        'event' => 'string',
        'data' => '\OpenAPI\Client\Model\BillingHandleCryptoWebhookRequestData'
    ];
    ...
    public const EVENT_PAYMENT_DETECTED = 'payment.detected';
    public const EVENT_PAYMENT_CONFIRMED = 'payment.confirmed';
    public const EVENT_PAYMENT_FINALIZED = 'payment.finalized';
    ...
    public function getEventAllowableValues()
    {
        return [
            ...
            self::EVENT_PAYMENT_DETECTED,
            self::EVENT_PAYMENT_CONFIRMED,
            self::EVENT_PAYMENT_FINALIZED,
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\BillingHandleCryptoWebhookRequestData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BillingHandleCryptoWebhookRequestData $data data
     *
     * @return self
     */
