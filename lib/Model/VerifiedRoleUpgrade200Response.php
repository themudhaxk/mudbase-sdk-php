...
/**
 * VerifiedRoleUpgrade200Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class VerifiedRoleUpgrade200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'verifiedRoleUpgrade_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('previous_role', $data ?? [], null);
        $this->setIfExists('upgrade_log', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets previous_role
     *
     * @param string|null $previous_role previous_role
     *
     * @return self
     */
    public function setPreviousRole($previous_role)
    {
        if (is_null($previous_role)) {
            throw new \InvalidArgumentException('non-nullable previous_role cannot be null');
        }
    ...
    {
        return $this->container['upgrade_log'];
    }

    /**
     * Sets upgrade_log
     *
     * @param string|null $upgrade_log upgrade_log
     *
     * @return self
     */
    public function setUpgradeLog($upgrade_log)
    {
        if (is_null($upgrade_log)) {
            throw new \InvalidArgumentException('non-nullable upgrade_log cannot be null');
        }
        $this->container['upgrade_log'] = $upgrade_log;
