...
class WebPushSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'endpoint' => 'string',
        'keys' => '\OpenAPI\Client\Model\WebPushSubscriptionKeys'
    ];
    ...
    */
     ...
     * Gets keys
     *
     * @return \OpenAPI\Client\Model\WebPushSubscriptionKeys
     */
     ...
     * Sets keys
     *
     * @param \OpenAPI\Client\Model\WebPushSubscriptionKeys $keys keys
     *
     * @return self
     */
