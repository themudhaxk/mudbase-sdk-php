...
/**
 * WebPushSubscription Class Doc Comment
 *
 * @category Class
 ...
 */
class WebPushSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushSubscription';
    ...
    protected static $openAPITypes = [
        'endpoint' => 'string',
        'keys' => '\MudbaseSDK\Model\WebPushSubscriptionKeys'
    ];
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string $endpoint The push-service endpoint URL returned by `pushManager.subscribe()`.
     *
     * @return self
     */
     ...
     * Gets keys
     *
     * @return \MudbaseSDK\Model\WebPushSubscriptionKeys
     */
     ...
     * Sets keys
     *
     * @param \MudbaseSDK\Model\WebPushSubscriptionKeys $keys keys
     *
     * @return self
     */
