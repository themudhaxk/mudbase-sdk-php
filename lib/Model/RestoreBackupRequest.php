...
/**
 * RestoreBackupRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class RestoreBackupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'restoreBackup_request';
    ...
    public const RESTORE_MODE_REPLACE = 'replace';
    public const RESTORE_MODE_MERGE = 'merge';
    public const CONFIRMATION_RESTORE_DATA = 'RESTORE_DATA';
    ...
    {
        return [
            self::RESTORE_MODE_REPLACE,
            self::RESTORE_MODE_MERGE,
        ];
    }
     ...
     * @return string[]
     */
    public function getConfirmationAllowableValues()
    {
        return [
            self::CONFIRMATION_RESTORE_DATA,
        ];
    }
    ...
    {
        $this->setIfExists('restore_mode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['restore_mode']) && !in_array($this->container['restore_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'restore_mode', must be one of '%s'",
                $this->container['restore_mode'],
        ...
        $allowedValues = $this->getConfirmationAllowableValues();
        if (!is_null($this->container['confirmation']) && !in_array($this->container['confirmation'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'confirmation', must be one of '%s'",
    ...
    {
        return $this->container['restore_mode'];
    }

    /**
     * Sets restore_mode
     *
     * @param string|null $restore_mode restore_mode
     *
     * @return self
     */
    public function setRestoreMode($restore_mode)
    {
        if (is_null($restore_mode)) {
            throw new \InvalidArgumentException('non-nullable restore_mode cannot be null');
        }
        $allowedValues = $this->getRestoreModeAllowableValues();
        if (!in_array($restore_mode, $allowedValues, true)) {
        ...
        $this->container['restore_mode'] = $restore_mode;
     ...
     * Sets collections
     *
     * @param string[]|null $collections Optional: specific collections to restore
     *
     * @return self
     */
    ...
    public function setConfirmation($confirmation)
    {
        ...
        $allowedValues = $this->getConfirmationAllowableValues();
        if (!in_array($confirmation, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'confirmation', must be one of '%s'",
                    $confirmation,
