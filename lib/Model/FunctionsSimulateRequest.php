...
/**
 * FunctionsSimulateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FunctionsSimulateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'functions_simulate_request';
    ...
    */
     ...
     * Sets event_context
     *
     * @param object|null $event_context Simulated event context (document, file, webhook, wallet, message)
     *
     * @return self
     */
