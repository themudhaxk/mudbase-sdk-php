...
/**
 * CreateBackupRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateBackupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBackup_request';
    ...
    protected static $attributeMap = [
        ...
        'include_wallets' => 'includeWallets'
    ];
    ...
    protected static $setters = [
        ...
        'include_wallets' => 'setIncludeWallets'
    ];
    ...
    protected static $getters = [
        ...
        'include_wallets' => 'getIncludeWallets'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('include_files', $data ?? [], true);
        $this->setIfExists('include_wallets', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets include_files
     *
     * @param bool|null $include_files include_files
     *
     * @return self
     */
    public function setIncludeFiles($include_files)
    {
        if (is_null($include_files)) {
            throw new \InvalidArgumentException('non-nullable include_files cannot be null');
        }
    ...
    /**
     * Gets include_wallets
     *
     * @return bool|null
     */
    public function getIncludeWallets()
    {
        return $this->container['include_wallets'];
    }

    /**
     * Sets include_wallets
     *
     * @param bool|null $include_wallets include_wallets
     *
     * @return self
     */
    public function setIncludeWallets($include_wallets)
    {
        if (is_null($include_wallets)) {
            throw new \InvalidArgumentException('non-nullable include_wallets cannot be null');
        }
        $this->container['include_wallets'] = $include_wallets;
