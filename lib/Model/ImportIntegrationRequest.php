...
/**
 * ImportIntegrationRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ImportIntegrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importIntegration_request';
    ...
    {
        $this->setIfExists('integration_data', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['integration_data'] === null) {
            $invalidProperties[] = "'integration_data' can't be null";
        }
    ...
    {
        if (is_null($integration_data)) {
            throw new \InvalidArgumentException('non-nullable integration_data cannot be null');
        }
