...
class AddCustomRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'requires_kyc' => 'bool',
        'default_permissions' => '\OpenAPI\Client\Model\AddCustomRoleRequestDefaultPermissionsInner[]',
        'collection_permissions' => 'array<string,\OpenAPI\Client\Model\CreateRoleRequestCollectionPermissionsValue>',
        'metadata' => 'object',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\AddCustomRoleRequestDefaultPermissionsInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AddCustomRoleRequestDefaultPermissionsInner[]|null $default_permissions Optional global/base permissions. For collection-level CRUD use `collectionPermissions`.
     *
     * @return self
     */
     ...
     *
     * @return array<string,\OpenAPI\Client\Model\CreateRoleRequestCollectionPermissionsValue>|null
     */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\CreateRoleRequestCollectionPermissionsValue>|null $collection_permissions Per-collection CRUD map (collection slug => actions or {actions,conditions}).
     *
     * @return self
     */
