...
/**
 * EraseUserData409Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class EraseUserData409Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'eraseUserData_409_response';
    ...
    protected static $setters = [
        'error' => 'setError',
        'sole_owned_orgs' => 'setSoleOwnedOrgs'
    ];
    ...
    protected static $getters = [
        'error' => 'getError',
        'sole_owned_orgs' => 'getSoleOwnedOrgs'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sole_owned_orgs', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets sole_owned_orgs
     *
     * @return string[]|null
     */
    public function getSoleOwnedOrgs()
    {
        return $this->container['sole_owned_orgs'];
    }

    /**
     * Sets sole_owned_orgs
     *
     * @param string[]|null $sole_owned_orgs sole_owned_orgs
     *
     * @return self
     */
    public function setSoleOwnedOrgs($sole_owned_orgs)
    {
        if (is_null($sole_owned_orgs)) {
            throw new \InvalidArgumentException('non-nullable sole_owned_orgs cannot be null');
        }
        $this->container['sole_owned_orgs'] = $sole_owned_orgs;
