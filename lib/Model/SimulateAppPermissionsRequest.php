...
/**
 * SimulateAppPermissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class SimulateAppPermissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'simulateAppPermissions_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('role_slug', $data ?? [], null);
    ...
    */
     ...
     * Sets role
     *
     * @param string $role App role slug (same as `roleSlug` elsewhere)
     *
     * @return self
     */
    ...
    {
        return $this->container['role_slug'];
    }

    /**
     * Sets role_slug
     *
     * @param string|null $role_slug Alias for `role`
     *
     * @return self
     */
    public function setRoleSlug($role_slug)
    {
        if (is_null($role_slug)) {
            throw new \InvalidArgumentException('non-nullable role_slug cannot be null');
        }
        $this->container['role_slug'] = $role_slug;
     ...
     * Sets operation_id
     *
     * @param string|null $operation_id OpenAPI operationId (e.g. `sendEmail`, `executeIntegration`). When set, path simulation is optional.
     *
     * @return self
     */
     ...
     * Sets pathname
     *
     * @param string|null $pathname Full path e.g. `/api/messaging/projects/{id}/messaging/email`
     *
     * @return self
     */
    ...
    {
        if (is_null($pathname)) {
            throw new \InvalidArgumentException('non-nullable pathname cannot be null');
        }
     ...
     * Sets path
     *
     * @param string|null $path Alias for `pathname`
     *
     * @return self
     */
