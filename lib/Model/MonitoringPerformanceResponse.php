...
/**
 * MonitoringPerformanceResponse Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class MonitoringPerformanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonitoringPerformanceResponse';
    ...
    protected static $openAPITypes = [
        'period' => 'string',
        'metrics' => '\MudbaseSDK\Model\MonitoringPerformanceResponseMetrics',
        'top_endpoints' => 'object[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('top_endpoints', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets metrics
     *
     * @return \MudbaseSDK\Model\MonitoringPerformanceResponseMetrics|null
     */
     ...
     * Sets metrics
     *
     * @param \MudbaseSDK\Model\MonitoringPerformanceResponseMetrics|null $metrics metrics
     *
     * @return self
     */
    ...
    {
        return $this->container['top_endpoints'];
    }

    /**
     * Sets top_endpoints
     *
     * @param object[]|null $top_endpoints top_endpoints
     *
     * @return self
     */
    public function setTopEndpoints($top_endpoints)
    {
        if (is_null($top_endpoints)) {
            throw new \InvalidArgumentException('non-nullable top_endpoints cannot be null');
        }
        $this->container['top_endpoints'] = $top_endpoints;
