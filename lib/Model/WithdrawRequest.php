...
class WithdrawRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'withdraw_request';
    ...
    */
     ...
     * Sets to_address
     *
     * @param string $to_address Recipient address (chain-specific format).
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount Amount to send (numeric; currency from wallet).
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string|null $network For USDT wallets only; ETH, BSC, TRX, SOL, or POLYGON.
     *
     * @return self
     */
