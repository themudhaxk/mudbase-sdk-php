...
/**
 * PutChatE2eeKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PutChatE2eeKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putChatE2eeKey_request';
    ...
    protected static $setters = [
        'identity_public_key' => 'setIdentityPublicKey',
        'key_version' => 'setKeyVersion'
    ];
    ...
    protected static $getters = [
        'identity_public_key' => 'getIdentityPublicKey',
    ...
    {
        $this->setIfExists('identity_public_key', $data ?? [], null);
        $this->setIfExists('key_version', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['identity_public_key'] === null) {
            $invalidProperties[] = "'identity_public_key' can't be null";
        }
    ...
    /**
     * Gets identity_public_key
     *
     * @return string
     */
    public function getIdentityPublicKey()
    {
        return $this->container['identity_public_key'];
    }

    /**
     * Sets identity_public_key
     *
     * @param string $identity_public_key Base64-encoded public key (algorithm defined by client; opaque to server)
     *
     * @return self
     */
    public function setIdentityPublicKey($identity_public_key)
    {
        if (is_null($identity_public_key)) {
            throw new \InvalidArgumentException('non-nullable identity_public_key cannot be null');
        }
        $this->container['identity_public_key'] = $identity_public_key;
    ...
    {
        return $this->container['key_version'];
    }

    /**
     * Sets key_version
     *
     * @param int|null $key_version Optional; defaults to incrementing stored version
     *
     * @return self
     */
    public function setKeyVersion($key_version)
    {
        if (is_null($key_version)) {
            throw new \InvalidArgumentException('non-nullable key_version cannot be null');
        }
        $this->container['key_version'] = $key_version;
