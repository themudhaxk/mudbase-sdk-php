...
class GetInvoices200ResponseInvoicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $hosted_invoice_url hosted_invoice_url
     *
     * @return self
     */
    public function setHostedInvoiceUrl($hosted_invoice_url)
    {
        if (is_null($hosted_invoice_url)) {
            array_push($this->openAPINullablesSetToNull, 'hosted_invoice_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hosted_invoice_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
