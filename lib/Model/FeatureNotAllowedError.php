...
/**
 * FeatureNotAllowedError Class Doc Comment
 *
 * @category Class
 * @description Returned when an app-role feature gate denies access (HTTP 403)
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FeatureNotAllowedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureNotAllowedError';
