...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'org' => '\MudbaseSDK\Model\OrganizationSummary'
    ];
    ...
    */
     ...
     * Sets custom_role
     *
     * @param string|null $custom_role Application-level role slug from the project's Multi-Role feature (e.g. \"customer\", \"seller\"). Null for org-level (org/admin/member/viewer) users who aren't project end-users.
     *
     * @return self
     */
    public function setCustomRole($custom_role)
    {
        if (is_null($custom_role)) {
            array_push($this->openAPINullablesSetToNull, 'custom_role');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_role', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets is_anonymous
     *
     * @param bool|null $is_anonymous True for a guest session created via POST /api/auth/anonymous that hasn't been converted to a full account yet.
     *
     * @return self
     */
     ...
     * Gets org
     *
     * @return \MudbaseSDK\Model\OrganizationSummary|null
     */
     ...
     * Sets org
     *
     * @param \MudbaseSDK\Model\OrganizationSummary|null $org org
     *
     * @return self
     */
