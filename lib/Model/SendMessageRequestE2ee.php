...
/**
 * SendMessageRequestE2ee Class Doc Comment
 *
 * @category Class
 ...
 */
class SendMessageRequestE2ee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sendMessage_request_e2ee';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sender_key_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['sender_key_id'];
    }

    /**
     * Sets sender_key_id
     *
     * @param string|null $sender_key_id sender_key_id
     *
     * @return self
     */
    public function setSenderKeyId($sender_key_id)
    {
        if (is_null($sender_key_id)) {
            throw new \InvalidArgumentException('non-nullable sender_key_id cannot be null');
        }
        $this->container['sender_key_id'] = $sender_key_id;
