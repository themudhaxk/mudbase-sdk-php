...
/**
 * SearchResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class SearchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchResponse_data';
    ...
    protected static $openAPITypes = [
        'results' => '\MudbaseSDK\Model\SearchResult[]',
        'pagination' => '\MudbaseSDK\Model\Pagination',
        'query' => 'string',
        'search_time' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('search_time', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets results
     *
     * @return \MudbaseSDK\Model\SearchResult[]|null
     */
     ...
     * Sets results
     *
     * @param \MudbaseSDK\Model\SearchResult[]|null $results results
     *
     * @return self
     */
     ...
     * Gets pagination
     *
     * @return \MudbaseSDK\Model\Pagination|null
     */
     ...
     * Sets pagination
     *
     * @param \MudbaseSDK\Model\Pagination|null $pagination pagination
     *
     * @return self
     */
     ...
     * Sets search_time
     *
     * @param int|null $search_time search_time
     *
     * @return self
     */
    public function setSearchTime($search_time)
    {
        if (is_null($search_time)) {
            throw new \InvalidArgumentException('non-nullable search_time cannot be null');
        }
