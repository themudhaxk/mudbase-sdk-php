...
/**
 * CreateAnonymousSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateAnonymousSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createAnonymousSession_request';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Project ID for the anonymous session
     *
     * @return self
     */
