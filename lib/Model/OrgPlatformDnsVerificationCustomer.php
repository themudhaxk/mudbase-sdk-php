...
/**
 * OrgPlatformDnsVerificationCustomer Class Doc Comment
 *
 * @category Class
 * @description Additional DNS record from platform staff (manual path), or the first certificate-provisioning TXT shim when automated provisioning is enabled. Prefer &#x60;dnsRecords&#x60; for full instructions. &#x60;staffNote&#x60; may appear in admin org detail only.
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrgPlatformDnsVerificationCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrgPlatformDnsVerificationCustomer';
    ...
    */
     ...
     * Sets record_name
     *
     * @param string|null $record_name record_name
     *
     * @return self
     */
