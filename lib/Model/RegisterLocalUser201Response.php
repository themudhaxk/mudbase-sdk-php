...
/**
 * RegisterLocalUser201Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class RegisterLocalUser201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'registerLocalUser_201_response';
    ...
    protected static $openAPITypes = [
        ...
        'expires_in' => 'int',
        'user' => '\MudbaseSDK\Model\RegisterLocalUser201ResponseUser'
    ];
    ...
    */
     ...
     *
     * @param bool|null $require_verification true when email verification is required; no token in response
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Present only when requireEmailVerification is false
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Present only when requireEmailVerification is false
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Present only when token is returned
     *
     * @return self
     */
     ...
     * Gets user
     *
     * @return \MudbaseSDK\Model\RegisterLocalUser201ResponseUser|null
     */
     ...
     * Sets user
     *
     * @param \MudbaseSDK\Model\RegisterLocalUser201ResponseUser|null $user user
     *
     * @return self
     */
