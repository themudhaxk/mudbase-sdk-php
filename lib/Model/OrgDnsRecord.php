...
/**
 * OrgDnsRecord Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class OrgDnsRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrgDnsRecord';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type DNS record type (TXT, CNAME, …)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Owner name / FQDN to create at the customer's DNS host
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Record value or CNAME target
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string $purpose mudbase_ownership, routing, fly_ownership, acme_challenge, or fly (legacy bucket).
     *
     * @return self
     */
