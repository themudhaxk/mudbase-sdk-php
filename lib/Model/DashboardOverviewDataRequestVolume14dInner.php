...
/**
 * DashboardOverviewDataRequestVolume14dInner Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class DashboardOverviewDataRequestVolume14dInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DashboardOverviewData_requestVolume14d_inner';
    ...
    protected static $attributeMap = [
        'date' => 'date',
        'api_calls' => 'apiCalls',
        'latency_tracked' => 'latencyTracked'
    ];
    ...
    protected static $setters = [
        ...
        'latency_tracked' => 'setLatencyTracked'
    ];
    ...
    protected static $getters = [
        ...
        'latency_tracked' => 'getLatencyTracked'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('latency_tracked', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets latency_tracked
     *
     * @return int|null
     */
    public function getLatencyTracked()
    {
        return $this->container['latency_tracked'];
    }

    /**
     * Sets latency_tracked
     *
     * @param int|null $latency_tracked Middleware-metered responses that day (UsageStat latencyCount)
     *
     * @return self
     */
    public function setLatencyTracked($latency_tracked)
    {
        if (is_null($latency_tracked)) {
            throw new \InvalidArgumentException('non-nullable latency_tracked cannot be null');
        }
        $this->container['latency_tracked'] = $latency_tracked;
