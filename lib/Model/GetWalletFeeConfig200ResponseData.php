...
/**
 * GetWalletFeeConfig200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetWalletFeeConfig200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWalletFeeConfig_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fee_percentage', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fee_percentage']) && ($this->container['fee_percentage'] > 1)) {
            $invalidProperties[] = "invalid value for 'fee_percentage', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['fee_percentage']) && ($this->container['fee_percentage'] < 0)) {
            $invalidProperties[] = "invalid value for 'fee_percentage', must be bigger than or equal to 0.";
        }
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether project-level fee is enabled (for non-custodial fee display/calculation)
     *
     * @return self
     */
     ...
     * Sets fee_percentage
     *
     * @param float|null $fee_percentage Project fee as decimal (e.g. 0.01 = 1%)
     *
     * @return self
     */
    public function setFeePercentage($fee_percentage)
    {
        if (is_null($fee_percentage)) {
            throw new \InvalidArgumentException('non-nullable fee_percentage cannot be null');
        }

        if (($fee_percentage > 1)) {
            throw new \InvalidArgumentException('invalid value for $fee_percentage when calling GetWalletFeeConfig200ResponseData., must be smaller than or equal to 1.');
        }
        if (($fee_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $fee_percentage when calling GetWalletFeeConfig200ResponseData., must be bigger than or equal to 0.');
        }
