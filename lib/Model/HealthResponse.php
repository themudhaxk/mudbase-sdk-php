...
class HealthResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'timestamp' => '\DateTime',
        'services' => '\MudbaseSDK\Model\HealthResponseServices',
        'version' => 'string',
        'uptime' => 'int'
    ];
    ...
    */
     ...
     * Gets services
     *
     * @return \MudbaseSDK\Model\HealthResponseServices|null
     */
     ...
     * Sets services
     *
     * @param \MudbaseSDK\Model\HealthResponseServices|null $services services
     *
     * @return self
     */
