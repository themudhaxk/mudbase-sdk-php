...
class CreateWalletRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createWallet_request';
    ...
    */
     ...
     * Sets currency
     *
     * @param string $currency Currency. USDT requires network (ETH, BSC, TRX, SOL, POLYGON). All platform chains supported for testing non-custodial flows.
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string|null $network Required for USDT; one of ETH, BSC, TRX, SOL, POLYGON
     *
     * @return self
     */
     ...
     * Sets private_key
     *
     * @param string|null $private_key Optional custom private key
     *
     * @return self
     */
