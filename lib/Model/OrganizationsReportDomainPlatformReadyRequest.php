...
/**
 * OrganizationsReportDomainPlatformReadyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationsReportDomainPlatformReadyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organizations_reportDomainPlatformReady_request';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OrganizationsReportDomainPlatformReadyRequest., must be smaller than or equal to 2000.');
        }
