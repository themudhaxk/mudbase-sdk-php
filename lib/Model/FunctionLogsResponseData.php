...
/**
 * FunctionLogsResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class FunctionLogsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FunctionLogsResponse_data';
    ...
    protected static $openAPITypes = [
        'executions' => '\MudbaseSDK\Model\FunctionExecution[]',
        'stats' => '\MudbaseSDK\Model\FunctionStats'
    ];
    ...
    {
        $this->setIfExists('executions', $data ?? [], null);
    ...
    */
     ...
     * Gets executions
     *
     * @return \MudbaseSDK\Model\FunctionExecution[]|null
     */
     ...
     * Sets executions
     *
     * @param \MudbaseSDK\Model\FunctionExecution[]|null $executions executions
     *
     * @return self
     */
    public function setExecutions($executions)
    {
        if (is_null($executions)) {
            throw new \InvalidArgumentException('non-nullable executions cannot be null');
        }
     ...
     * Gets stats
     *
     * @return \MudbaseSDK\Model\FunctionStats|null
     */
     ...
     * Sets stats
     *
     * @param \MudbaseSDK\Model\FunctionStats|null $stats stats
     *
     * @return self
     */
