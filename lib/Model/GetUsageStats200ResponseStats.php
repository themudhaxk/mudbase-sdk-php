...
/**
 * GetUsageStats200ResponseStats Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetUsageStats200ResponseStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getUsageStats_200_response_stats';
    ...
    protected static $setters = [
        ...
        'success_calls' => 'setSuccessCalls',
        'failed_calls' => 'setFailedCalls'
    ];
    ...
    protected static $getters = [
        ...
        'success_calls' => 'getSuccessCalls',
        'failed_calls' => 'getFailedCalls'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('success_calls', $data ?? [], null);
        $this->setIfExists('failed_calls', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets total_calls
     *
     * @param int|null $total_calls total_calls
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getSuccessCalls()
    {
        return $this->container['success_calls'];
    }

    /**
     * Sets success_calls
     *
     * @param int|null $success_calls success_calls
     *
     * @return self
     */
    public function setSuccessCalls($success_calls)
    {
        if (is_null($success_calls)) {
            throw new \InvalidArgumentException('non-nullable success_calls cannot be null');
        }
        $this->container['success_calls'] = $success_calls;
    ...
    {
        return $this->container['failed_calls'];
    }

    /**
     * Sets failed_calls
     *
     * @param int|null $failed_calls failed_calls
     *
     * @return self
     */
    public function setFailedCalls($failed_calls)
    {
        if (is_null($failed_calls)) {
            throw new \InvalidArgumentException('non-nullable failed_calls cannot be null');
        }
        $this->container['failed_calls'] = $failed_calls;
