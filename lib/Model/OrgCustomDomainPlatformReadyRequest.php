...
/**
 * OrgCustomDomainPlatformReadyRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class OrgCustomDomainPlatformReadyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orgCustomDomainPlatformReady_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['note']) && (mb_strlen($this->container['note']) > 2000)) {
            $invalidProperties[] = "invalid value for 'note', the character length must be smaller than or equal to 2000.";
        }
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OrgCustomDomainPlatformReadyRequest., must be smaller than or equal to 2000.');
        }
