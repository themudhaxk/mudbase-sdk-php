...
/**
 * EstimateNonCustodialGasRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EstimateNonCustodialGasRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'estimateNonCustodialGas_request';
    ...
    protected static $openAPITypes = [
        'chain' => 'string',
        'transaction' => '\OpenAPI\Client\Model\EstimateNonCustodialGasRequestTransaction'
    ];
    ...
    */
     ...
     * Sets chain
     *
     * @param string $chain Chain id. For EVM, transaction is required. For non-EVM (UTXO, Solana, Tron, TON, Cardano) only chain is needed.
     *
     * @return self
     */
     ...
     * Gets transaction
     *
     * @return \OpenAPI\Client\Model\EstimateNonCustodialGasRequestTransaction|null
     */
     ...
     * Sets transaction
     *
     * @param \OpenAPI\Client\Model\EstimateNonCustodialGasRequestTransaction|null $transaction transaction
     *
     * @return self
     */
