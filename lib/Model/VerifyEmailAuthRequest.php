...
/**
 * VerifyEmailAuthRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class VerifyEmailAuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'verifyEmailAuth_request';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Optional; for project signup context (redirect hint)
     *
     * @return self
     */
