...
/**
 * ApiKycSessionsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiKycSessionsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_kyc_sessions_post_request';
    ...
    */
     ...
     * Sets language
     *
     * @param string|null $language Optional ISO language code for the verification UI.
     *
     * @return self
     */
