...
/**
 * EditMessage200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class EditMessage200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'editMessage_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_e2ee', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsE2ee()
    {
        return $this->container['is_e2ee'];
    }

    /**
     * Sets is_e2ee
     *
     * @param bool|null $is_e2ee is_e2ee
     *
     * @return self
     */
    public function setIsE2ee($is_e2ee)
    {
        if (is_null($is_e2ee)) {
            throw new \InvalidArgumentException('non-nullable is_e2ee cannot be null');
        }
        $this->container['is_e2ee'] = $is_e2ee;
