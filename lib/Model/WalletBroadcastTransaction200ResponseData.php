...
/**
 * WalletBroadcastTransaction200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WalletBroadcastTransaction200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wallet_broadcastTransaction_200_response_data';
    ...
    */
     ...
     * Sets currency
     *
     * @param string|null $currency Native currency for the chain (ETH, BNB, MATIC, etc.)
     *
     * @return self
     */
