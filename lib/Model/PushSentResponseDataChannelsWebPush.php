...
/**
 * PushSentResponseDataChannelsWebPush Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PushSentResponseDataChannelsWebPush implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushSentResponse_data_channels_webPush';
    ...
    */
     ...
     * Sets pruned
     *
     * @param int|null $pruned Subscriptions the push service reported as gone (404/410) and that were pruned during this send.
     *
     * @return self
     */
