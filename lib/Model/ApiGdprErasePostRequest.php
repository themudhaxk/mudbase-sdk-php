...
/**
 * ApiGdprErasePostRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiGdprErasePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_gdpr_erase_post_request';
     ...
     * @return string[]
     */
    public function getConfirmAllowableValues()
    {
        return [
            self::CONFIRM_DELETE,
        ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('totp_token', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getConfirmAllowableValues();
        if (!is_null($this->container['confirm']) && !in_array($this->container['confirm'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'confirm', must be one of '%s'",
     ...
     * Sets confirm
     *
     * @param string $confirm Must equal \"DELETE\" to proceed with erasure.
     *
     * @return self
     */
    public function setConfirm($confirm)
    {
        ...
        $allowedValues = $this->getConfirmAllowableValues();
        if (!in_array($confirm, $allowedValues, true)) {
     ...
     *
     * @param string|null $current_password Required unless the account has no password set (OAuth-only)
     *
     * @return self
     */
    ...
    {
        return $this->container['totp_token'];
    }

    /**
     * Sets totp_token
     *
     * @param string|null $totp_token Required only if the account has 2FA enabled
     *
     * @return self
     */
    public function setTotpToken($totp_token)
    {
        if (is_null($totp_token)) {
            throw new \InvalidArgumentException('non-nullable totp_token cannot be null');
        }
        $this->container['totp_token'] = $totp_token;
