...
/**
 * DataListResponseDataInner Class Doc Comment
 *
 * @category Class
 ...
 */
class DataListResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataListResponse_data_inner';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Document ID (MongoDB ObjectId) - use this as documentId in API calls
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Document creation timestamp
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Document last update timestamp
     *
     * @return self
     */
