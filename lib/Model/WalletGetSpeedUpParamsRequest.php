...
/**
 * WalletGetSpeedUpParamsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WalletGetSpeedUpParamsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wallet_getSpeedUpParams_request';
    ...
    */
     ...
     * Sets tx_id
     *
     * @param string|null $tx_id WalletTransaction _id (MongoDB ObjectId)
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string $chain EVM chain (speed-up is EVM only)
     *
     * @return self
     */
