...
/**
 * UpdateBucketRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateBucketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBucketRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Updated name of the bucket
     *
     * @return self
     */
     ...
     * Sets is_public
     *
     * @param bool|null $is_public Update whether the bucket is publicly accessible
     *
     * @return self
     */
     ...
     * Sets settings
     *
     * @param object|null $settings Updated bucket settings
     *
     * @return self
     */
