...
/**
 * UpdateMultiRoleSettings200Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMultiRoleSettings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateMultiRoleSettings_200_response';
    ...
    */
     ...
     * Sets data
     *
     * @param object|null $data Same shape as GET `/multi-role` — `isEnabled`, `defaultRole`, `settings`, and `roles` (no raw MultiRoleFeature document).
     *
     * @return self
     */
