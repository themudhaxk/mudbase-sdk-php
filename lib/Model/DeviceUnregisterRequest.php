...
/**
 * DeviceUnregisterRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class DeviceUnregisterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceUnregisterRequest';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token The device push token to remove from the project.
     *
     * @return self
     */
