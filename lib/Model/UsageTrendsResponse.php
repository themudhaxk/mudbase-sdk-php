...
/**
 * UsageTrendsResponse Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UsageTrendsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageTrendsResponse';
    ...
    protected static $openAPITypes = [
        'trends' => '\MudbaseSDK\Model\UsageTrendsResponseTrendsInner[]',
        'period' => 'string'
    ];
    ...
    {
        $this->setIfExists('trends', $data ?? [], null);
    ...
    */
     ...
     * Gets trends
     *
     * @return \MudbaseSDK\Model\UsageTrendsResponseTrendsInner[]|null
     */
     ...
     * Sets trends
     *
     * @param \MudbaseSDK\Model\UsageTrendsResponseTrendsInner[]|null $trends trends
     *
     * @return self
     */
    ...
    {
        if (is_null($trends)) {
            throw new \InvalidArgumentException('non-nullable trends cannot be null');
        }
