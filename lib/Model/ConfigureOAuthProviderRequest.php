...
/**
 * ConfigureOAuthProviderRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ConfigureOAuthProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'configureOAuthProvider_request';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool $enabled Whether the OAuth provider is enabled
     *
     * @return self
     */
     ...
     * Sets client_id
     *
     * @param string $client_id OAuth client ID from the provider
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret OAuth client secret from the provider
     *
     * @return self
     */
