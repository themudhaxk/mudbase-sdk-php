...
/**
 * RealtimeAnalyticsGetActiveUsers200ResponseUsersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RealtimeAnalyticsGetActiveUsers200ResponseUsersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'realtimeAnalytics_getActiveUsers_200_response_users_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('socket_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['socket_id'];
    }

    /**
     * Sets socket_id
     *
     * @param string|null $socket_id socket_id
     *
     * @return self
     */
    public function setSocketId($socket_id)
    {
        if (is_null($socket_id)) {
            throw new \InvalidArgumentException('non-nullable socket_id cannot be null');
        }
        $this->container['socket_id'] = $socket_id;
