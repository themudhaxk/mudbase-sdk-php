...
/**
 * UpdateNonCustodialAddressRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNonCustodialAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNonCustodialAddress_request';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label Human-readable label for the address
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling UpdateNonCustodialAddressRequest., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param string|null $derivation_path BIP derivation path (e.g. m/44'/60'/0'/0/0); can be set to null to clear
     *
     * @return self
     */
