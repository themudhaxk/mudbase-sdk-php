...
/**
 * WebPushSubscribeRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebPushSubscribeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushSubscribeRequest';
    ...
    protected static $openAPITypes = [
        'subscription' => '\MudbaseSDK\Model\WebPushSubscription',
        'user_id' => 'string',
        'device_id' => 'string'
    ];
    ...
    */
     ...
     * Gets subscription
     *
     * @return \MudbaseSDK\Model\WebPushSubscription
     */
     ...
     * Sets subscription
     *
     * @param \MudbaseSDK\Model\WebPushSubscription $subscription subscription
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string|null $user_id Optional end-user id to associate with this subscription, for targeted sends.
     *
     * @return self
     */
     ...
     * Sets device_id
     *
     * @param string|null $device_id Optional client-supplied device identifier.
     *
     * @return self
     */
