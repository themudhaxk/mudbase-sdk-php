...
/**
 * PatchOrgDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrgDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrgDomainRequest';
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'regenerate_token' => 'setRegenerateToken'
    ];
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'regenerate_token' => 'getRegenerateToken'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('regenerate_token', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Org self-serve reset only; go-live is via admin activate.
     *
     * @return self
     */
    ...
    /**
     * Gets regenerate_token
     *
     * @return bool|null
     */
    public function getRegenerateToken()
    {
        return $this->container['regenerate_token'];
    }

    /**
     * Sets regenerate_token
     *
     * @param bool|null $regenerate_token regenerate_token
     *
     * @return self
     */
    public function setRegenerateToken($regenerate_token)
    {
        if (is_null($regenerate_token)) {
            throw new \InvalidArgumentException('non-nullable regenerate_token cannot be null');
        }
        $this->container['regenerate_token'] = $regenerate_token;
