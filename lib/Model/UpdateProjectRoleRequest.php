...
class UpdateProjectRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\CreateRoleRequestCollectionPermissionsValue>|null $collection_permissions Per-collection CRUD map (same as POST add role).
     *
     * @return self
     */
