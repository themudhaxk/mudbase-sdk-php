...
/**
 * UpdateProjectRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateProjectRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateProjectRole_request';
    ...
    */
     ...
     *
     * @param array<string,\MudbaseSDK\Model\CreateRoleRequestCollectionPermissionsValue>|null $collection_permissions Per-collection CRUD map (same as POST add role).
     *
     * @return self
     */
