...
/**
 * DeviceRegisterRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class DeviceRegisterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceRegisterRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('platform', $data ?? [], 'unknown');
    }
    ...
    */
     ...
     * Sets token
     *
     * @param string $token The device push token issued to your app by its push client.
     *
     * @return self
     */
     ...
     * Sets platform
     *
     * @param string|null $platform The device platform. Defaults to `unknown` when omitted or unrecognized.
     *
     * @return self
     */
