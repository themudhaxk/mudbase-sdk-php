...
/**
 * AuthLogin200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthLogin200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_login_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'expires_in' => 'int',
        'user' => '\OpenAPI\Client\Model\AuthLogin200ResponseUser'
    ];
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token JWT access token (use in Authorization Bearer header)
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token JWT refresh token (use with POST /api/auth/refresh to get new token pair)
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Access token TTL in seconds (e.g. 1800 for 30 minutes)
     *
     * @return self
     */
     ...
     * Gets user
     *
     * @return \OpenAPI\Client\Model\AuthLogin200ResponseUser|null
     */
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\AuthLogin200ResponseUser|null $user user
     *
     * @return self
     */
