...
class CreateOrganizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parent_org_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets parent_org_id
     *
     * @param string|null $parent_org_id parent_org_id
     *
     * @return self
     */
    public function setParentOrgId($parent_org_id)
    {
        if (is_null($parent_org_id)) {
            throw new \InvalidArgumentException('non-nullable parent_org_id cannot be null');
        }
