...
/**
 * SimulateFunctionTriggerRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class SimulateFunctionTriggerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'simulateFunctionTrigger_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('event_context', $data ?? [], null);
    ...
    */
     ...
     * Sets trigger
     *
     * @param object|null $trigger Simulated trigger (type, event)
     *
     * @return self
     */
    ...
    {
        return $this->container['event_context'];
    }

    /**
     * Sets event_context
     *
     * @param object|null $event_context Simulated event context (document, file, webhook, message)
     *
     * @return self
     */
    public function setEventContext($event_context)
    {
        if (is_null($event_context)) {
            throw new \InvalidArgumentException('non-nullable event_context cannot be null');
        }
        $this->container['event_context'] = $event_context;
     ...
     * Sets payload
     *
     * @param object|null $payload Additional payload
     *
     * @return self
     */
