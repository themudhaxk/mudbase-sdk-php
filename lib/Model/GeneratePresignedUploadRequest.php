...
/**
 * GeneratePresignedUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GeneratePresignedUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generatePresignedUpload_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bucket', $data ?? [], 'default');
