...
class WalletTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'token_transfers' => '\OpenAPI\Client\Model\WalletTransactionTokenTransfersInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'token_transfers' => 'setTokenTransfers'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('token_transfers', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets token_transfers
     *
     * @return \OpenAPI\Client\Model\WalletTransactionTokenTransfersInner[]|null
     */
    public function getTokenTransfers()
    {
        return $this->container['token_transfers'];
    }

    /**
     * Sets token_transfers
     *
     * @param \OpenAPI\Client\Model\WalletTransactionTokenTransfersInner[]|null $token_transfers Parsed token transfer list (incoming and outgoing) when available
     *
     * @return self
     */
    public function setTokenTransfers($token_transfers)
    {
        if (is_null($token_transfers)) {
            throw new \InvalidArgumentException('non-nullable token_transfers cannot be null');
        }
        $this->container['token_transfers'] = $token_transfers;
