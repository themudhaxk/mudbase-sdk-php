...
/**
 * ResendVerificationAuthRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ResendVerificationAuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resendVerificationAuth_request';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Optional; for project-scoped signup (sends link with project context)
     *
     * @return self
     */
