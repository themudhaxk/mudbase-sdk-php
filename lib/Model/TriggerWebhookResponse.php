...
/**
 * TriggerWebhookResponse Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class TriggerWebhookResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TriggerWebhookResponse';
    ...
    */
     ...
     * Sets webhook_id
     *
     * @param string $webhook_id WebhookLog._id for this delivery; use in POST /api/webhooks/retry/{webhookId}
     *
     * @return self
     */
