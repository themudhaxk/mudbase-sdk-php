...
class AuthConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'providers' => '\OpenAPI\Client\Model\AuthProvider[]',
    ...
    */
     ...
     * Gets providers
     *
     * @return \OpenAPI\Client\Model\AuthProvider[]|null
     */
     ...
     * Sets providers
     *
     * @param \OpenAPI\Client\Model\AuthProvider[]|null $providers providers
     *
     * @return self
     */
     ...
     *
     * @param bool|null $notify_on_new_sign_in When true, a \"new sign-in detected\" email is sent to the user on each app sign-in (local or OAuth). Counts against the org's messaging/email plan quota. Default false. Organization-based sign-in always sends this email (no quota deduction).
     *
     * @return self
     */
