...
/**
 * EnablePaymentProcessing200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class EnablePaymentProcessing200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enablePaymentProcessing_200_response_data';
    ...
    protected static $setters = [
        ...
        'already_enabled' => 'setAlreadyEnabled'
    ];
    ...
    protected static $getters = [
        ...
        'already_enabled' => 'getAlreadyEnabled'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('already_enabled', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets already_enabled
     *
     * @return bool|null
     */
    public function getAlreadyEnabled()
    {
        return $this->container['already_enabled'];
    }

    /**
     * Sets already_enabled
     *
     * @param bool|null $already_enabled already_enabled
     *
     * @return self
     */
    public function setAlreadyEnabled($already_enabled)
    {
        if (is_null($already_enabled)) {
            throw new \InvalidArgumentException('non-nullable already_enabled cannot be null');
        }
        $this->container['already_enabled'] = $already_enabled;
