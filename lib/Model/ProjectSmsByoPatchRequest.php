...
/**
 * ProjectSmsByoPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ProjectSmsByoPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectSmsByoPatchRequest';
    ...
    */
     ...
     * Sets default_from
     *
     * @param string|null $default_from Default sender (E.164 for Twilio; Termii/Africa's Talking may use alphanumeric or approved sender IDs per provider rules).
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param array<string,mixed>|null $config Provider credentials and options (encrypted at rest). Required keys when enabling BYO: **twilio** — `accountSid`, `authToken`. Optional `from`. **termii** — `apiKey`. Optional `from`. **africastalking** — `username`, `apiKey`. Optional `from`.
     *
     * @return self
     */
