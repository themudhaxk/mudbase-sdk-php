...
/**
 * AuthRequestPasswordResetRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthRequestPasswordResetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_requestPasswordReset_request';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Required for app reset (sends OTP). Omit for org token link.
     *
     * @return self
     */
