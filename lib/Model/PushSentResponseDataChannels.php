...
/**
 * PushSentResponseDataChannels Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class PushSentResponseDataChannels implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushSentResponse_data_channels';
    ...
    protected static $openAPITypes = [
        'fcm' => '\MudbaseSDK\Model\PushSentResponseDataChannelsFcm',
        'web_push' => '\MudbaseSDK\Model\PushSentResponseDataChannelsWebPush'
    ];
    ...
    */
     ...
     * Gets fcm
     *
     * @return \MudbaseSDK\Model\PushSentResponseDataChannelsFcm|null
     */
     ...
     * Sets fcm
     *
     * @param \MudbaseSDK\Model\PushSentResponseDataChannelsFcm|null $fcm fcm
     *
     * @return self
     */
    ...
    {
        if (is_null($fcm)) {
            array_push($this->openAPINullablesSetToNull, 'fcm');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fcm', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets web_push
     *
     * @return \MudbaseSDK\Model\PushSentResponseDataChannelsWebPush|null
     */
     ...
     * Sets web_push
     *
     * @param \MudbaseSDK\Model\PushSentResponseDataChannelsWebPush|null $web_push web_push
     *
     * @return self
     */
    ...
    {
        if (is_null($web_push)) {
            array_push($this->openAPINullablesSetToNull, 'web_push');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('web_push', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
