...
class PresignedPostResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url URL to POST the multipart form to
     *
     * @return self
     */
     ...
     * Sets fields
     *
     * @param object|null $fields Form fields required for the presigned POST (Policy, X-Amz-Signature, etc.)
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Expiration of the presigned POST in seconds
     *
     * @return self
     */
