...
/**
 * AuthRefresh200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthRefresh200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_refresh_200_response';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token New JWT access token
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token New refresh token (store and use for next refresh)
     *
     * @return self
     */
