...
/**
 * WebPushConfigResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebPushConfigResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushConfigResponse_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vapid_subject', $data ?? [], null);
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether native Web Push is enabled for this project.
     *
     * @return self
     */
     ...
     * Sets has_keys
     *
     * @param bool|null $has_keys Whether a VAPID keypair has been provisioned.
     *
     * @return self
     */
     ...
     * Sets public_key
     *
     * @param string|null $public_key The VAPID application-server public key clients subscribe with. Null when native Web Push is not enabled.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getVapidSubject()
    {
        return $this->container['vapid_subject'];
    }

    /**
     * Sets vapid_subject
     *
     * @param string|null $vapid_subject RFC 8292 contact subject (a `mailto:` address or `https` URL).
     *
     * @return self
     */
    public function setVapidSubject($vapid_subject)
    {
        if (is_null($vapid_subject)) {
            array_push($this->openAPINullablesSetToNull, 'vapid_subject');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vapid_subject', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['vapid_subject'] = $vapid_subject;
     ...
     * Sets generated_at
     *
     * @param \DateTime|null $generated_at When the current VAPID keypair was generated.
     *
     * @return self
     */
