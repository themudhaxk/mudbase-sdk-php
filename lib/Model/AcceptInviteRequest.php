...
/**
 * AcceptInviteRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class AcceptInviteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'acceptInvite_request';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Invitation token from the invite email link
     *
     * @return self
     */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling AcceptInviteRequest., must be bigger than or equal to 8.');
        }
