...
/**
 * WebPushConfigPatchRequest Class Doc Comment
 *
 * @category Class
 * @description All fields optional. &#x60;enabled&#x60; toggles native Web Push (and provisions a keypair on first enable); &#x60;rotateKeys&#x60; regenerates the keypair (invalidating existing subscriptions); &#x60;subject&#x60; sets the RFC 8292 contact URI.
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WebPushConfigPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushConfigPatchRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rotate_keys', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getRotateKeys()
    {
        return $this->container['rotate_keys'];
    }

    /**
     * Sets rotate_keys
     *
     * @param bool|null $rotate_keys rotate_keys
     *
     * @return self
     */
    public function setRotateKeys($rotate_keys)
    {
        if (is_null($rotate_keys)) {
            throw new \InvalidArgumentException('non-nullable rotate_keys cannot be null');
        }
        $this->container['rotate_keys'] = $rotate_keys;
     ...
     * Sets subject
     *
     * @param string|null $subject A `mailto:` address or an `https` URL.
     *
     * @return self
     */
