...
/**
 * AddOrgDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class AddOrgDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOrgDomainRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('set_primary', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['set_primary'];
    }

    /**
     * Sets set_primary
     *
     * @param bool|null $set_primary set_primary
     *
     * @return self
     */
    public function setSetPrimary($set_primary)
    {
        if (is_null($set_primary)) {
            throw new \InvalidArgumentException('non-nullable set_primary cannot be null');
        }
        $this->container['set_primary'] = $set_primary;
