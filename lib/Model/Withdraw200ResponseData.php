...
/**
 * Withdraw200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Withdraw200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'withdraw_200_response_data';
    ...
    public const STATUS_READY_TO_BROADCAST = 'ready_to_broadcast';
    ...
    {
        return [
            self::STATUS_READY_TO_BROADCAST,
        ];
    }
    ...
    */
     ...
     * Sets signed_tx
     *
     * @param string|null $signed_tx Signed transaction (hex for EVM/UTXO, base64 for Solana, object for Tron). Send as-is in broadcast body.
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string|null $chain Chain id for broadcast (e.g. ethereum, bitcoin, solana).
     *
     * @return self
     */
     ...
     * Sets from_address
     *
     * @param string|null $from_address Sender address; must be registered for org when broadcasting.
     *
     * @return self
     */
