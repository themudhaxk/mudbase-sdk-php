...
/**
 * MultiRoleSimulateAppPermissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MultiRoleSimulateAppPermissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multiRole_simulateAppPermissions_request';
    ...
    */
     ...
     * Sets operation_id
     *
     * @param string|null $operation_id OpenAPI operationId (e.g. sendEmail). Optional if method + pathname are sent.
     *
     * @return self
     */
     ...
     * Sets pathname
     *
     * @param string|null $pathname Full API path, e.g. /api/messaging/projects/{projectId}/messaging/email
     *
     * @return self
     */
