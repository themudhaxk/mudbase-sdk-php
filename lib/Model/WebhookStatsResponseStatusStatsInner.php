...
/**
 * WebhookStatsResponseStatusStatsInner Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebhookStatsResponseStatusStatsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookStatsResponse_statusStats_inner';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Status key (pending, success, failed, retrying)
     *
     * @return self
     */
     ...
     * Sets avg_duration
     *
     * @param float|null $avg_duration Average duration in ms for that status bucket
     *
     * @return self
     */
    public function setAvgDuration($avg_duration)
    {
        if (is_null($avg_duration)) {
            array_push($this->openAPINullablesSetToNull, 'avg_duration');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('avg_duration', $nullablesSetToNull);
            if ($index !== FALSE) {
