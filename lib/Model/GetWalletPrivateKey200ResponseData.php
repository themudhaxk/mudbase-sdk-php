...
/**
 * GetWalletPrivateKey200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetWalletPrivateKey200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWalletPrivateKey_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_custom_key', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsCustomKey()
    {
        return $this->container['is_custom_key'];
    }

    /**
     * Sets is_custom_key
     *
     * @param bool|null $is_custom_key is_custom_key
     *
     * @return self
     */
    public function setIsCustomKey($is_custom_key)
    {
        if (is_null($is_custom_key)) {
            throw new \InvalidArgumentException('non-nullable is_custom_key cannot be null');
        }
        $this->container['is_custom_key'] = $is_custom_key;
