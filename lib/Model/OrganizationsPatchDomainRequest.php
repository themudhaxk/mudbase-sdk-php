...
/**
 * OrganizationsPatchDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationsPatchDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organizations_patchDomain_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Org self-serve only pending or failed. Live (active) is set by platform admin.
     *
     * @return self
     */
