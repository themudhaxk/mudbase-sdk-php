...
/**
 * RegisterWithRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class RegisterWithRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'registerWithRole_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('agreed_to_terms', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agreed_to_terms'] === null) {
            $invalidProperties[] = "'agreed_to_terms' can't be null";
        }
     ...
     *
     * @param bool $agreed_to_terms Must be `true` - the server rejects the request otherwise. Required to stop a direct API call from creating an account without accepting the Terms of Service and Privacy Policy.
     *
     * @return self
     */
    public function setAgreedToTerms($agreed_to_terms)
    {
        if (is_null($agreed_to_terms)) {
            throw new \InvalidArgumentException('non-nullable agreed_to_terms cannot be null');
        }
