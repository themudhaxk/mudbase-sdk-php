...
/**
 * EstimateNetworkFeeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EstimateNetworkFeeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'estimateNetworkFee_request';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Transaction amount (used for display; fee is chain-based)
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount <= 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling EstimateNetworkFeeRequest., must be bigger than 0.');
        }
     ...
     * Sets network
     *
     * @param string|null $network Required for USDT; network on which USDT is sent
     *
     * @return self
     */
