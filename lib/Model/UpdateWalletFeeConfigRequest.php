...
/**
 * UpdateWalletFeeConfigRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateWalletFeeConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateWalletFeeConfig_request';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Enable or disable project-level fee (for non-custodial fee calculation)
     *
     * @return self
     */
     ...
     * Sets fee_percentage
     *
     * @param float|null $fee_percentage Project fee as decimal (e.g. 0.01 = 1%, 0.005 = 0.5%)
     *
     * @return self
     */
    public function setFeePercentage($fee_percentage)
    {
        ...
        if (($fee_percentage > 1)) {
            throw new \InvalidArgumentException('invalid value for $fee_percentage when calling UpdateWalletFeeConfigRequest., must be smaller than or equal to 1.');
        }
        if (($fee_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $fee_percentage when calling UpdateWalletFeeConfigRequest., must be bigger than or equal to 0.');
        }
