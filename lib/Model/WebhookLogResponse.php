 ...
 *
 * @category Class
 * @description Last HTTP response from your server (if any)
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WebhookLogResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookLog_response';
    ...
    */
     ...
     * Sets status
     *
     * @param int|null $status HTTP status code from your endpoint
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param object|null $body Parsed JSON when possible; otherwise structure varies
     *
     * @return self
     */
