...
/**
 * AcceptInvite201Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class AcceptInvite201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'acceptInvite_201_response';
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'token' => 'string',
        'user' => '\MudbaseSDK\Model\AcceptInvite201ResponseUser'
    ];
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token JWT for the new user session
     *
     * @return self
     */
     ...
     * Gets user
     *
     * @return \MudbaseSDK\Model\AcceptInvite201ResponseUser|null
     */
     ...
     * Sets user
     *
     * @param \MudbaseSDK\Model\AcceptInvite201ResponseUser|null $user user
     *
     * @return self
     */
