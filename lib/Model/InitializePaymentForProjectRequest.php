...
/**
 * InitializePaymentForProjectRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class InitializePaymentForProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initializePaymentForProject_request';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InitializePaymentForProjectRequest., must be bigger than or equal to 0.01.');
        }
