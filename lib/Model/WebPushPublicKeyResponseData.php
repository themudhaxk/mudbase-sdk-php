...
/**
 * WebPushPublicKeyResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebPushPublicKeyResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushPublicKeyResponse_data';
    ...
    */
     ...
     * Sets public_key
     *
     * @param string|null $public_key The VAPID application-server public key, or null when native Web Push is not enabled.
     *
     * @return self
     */
