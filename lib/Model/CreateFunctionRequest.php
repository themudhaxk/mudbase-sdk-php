...
class CreateFunctionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Function body (async, has access to payload, db, files, messaging, utils, env, console)
     *
     * @return self
     */
     ...
     * Gets trigger
     *
     * @return \MudbaseSDK\Model\FunctionTrigger
     */
     ...
     * Sets trigger
     *
     * @param \MudbaseSDK\Model\FunctionTrigger $trigger trigger
     *
     * @return self
     */
