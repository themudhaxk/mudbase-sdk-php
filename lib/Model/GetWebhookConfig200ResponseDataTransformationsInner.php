...
/**
 * GetWebhookConfig200ResponseDataTransformationsInner Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetWebhookConfig200ResponseDataTransformationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getWebhookConfig_200_response_data_transformations_inner';
    ...
    public const TYPE_JSON_PATH = 'jsonPath';
    public const TYPE_TEMPLATE = 'template';
    public const TYPE_FIELD_MAP = 'fieldMap';
    public const TYPE_FILTER = 'filter';
    public const TYPE_FLATTEN = 'flatten';
    ...
    */
     ...
     * Sets config
     *
     * @param object|null $config Transformation-specific configuration (shape depends on `type`)
     *
     * @return self
     */
