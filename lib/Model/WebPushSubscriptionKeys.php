...
/**
 * WebPushSubscriptionKeys Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebPushSubscriptionKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushSubscription_keys';
    ...
    {
        $this->setIfExists('p256dh', $data ?? [], null);
    ...
    */
     ...
     * Sets p256dh
     *
     * @param string $p256dh The subscription's P-256 ECDH public key (base64url).
     *
     * @return self
     */
    ...
    {
        if (is_null($p256dh)) {
            throw new \InvalidArgumentException('non-nullable p256dh cannot be null');
        }
