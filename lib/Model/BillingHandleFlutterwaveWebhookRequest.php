...
/**
 * BillingHandleFlutterwaveWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BillingHandleFlutterwaveWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billing_handleFlutterwaveWebhook_request';
    ...
    protected static $openAPITypes = [
        'event' => 'string',
        'data' => '\OpenAPI\Client\Model\BillingHandleFlutterwaveWebhookRequestData'
    ];
    ...
    */
     ...
     * Sets event
     *
     * @param string|null $event Event type (e.g. charge.completed, payment.successful)
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\BillingHandleFlutterwaveWebhookRequestData|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BillingHandleFlutterwaveWebhookRequestData|null $data data
     *
     * @return self
     */
