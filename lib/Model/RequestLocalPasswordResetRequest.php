...
/**
 * RequestLocalPasswordResetRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class RequestLocalPasswordResetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requestLocalPasswordReset_request';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Required for project-based reset (sends OTP). Omit for org token link.
     *
     * @return self
     */
