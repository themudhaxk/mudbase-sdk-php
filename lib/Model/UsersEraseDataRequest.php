...
/**
 * UsersEraseDataRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UsersEraseDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_eraseData_request';
    ...
    public const CONFIRMATION_DELETE_MY_ACCOUNT = 'DELETE_MY_ACCOUNT';
    ...
    {
        return [
            self::CONFIRMATION_DELETE_MY_ACCOUNT,
        ];
    }
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason Optional reason for account deletion
     *
     * @return self
     */
