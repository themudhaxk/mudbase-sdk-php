...
class TriggerWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets project_id
     *
     * @param string $project_id Target project (must belong to your org)
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url HTTPS URL validated against SSRF rules
     *
     * @return self
     */
     ...
     * Sets event
     *
     * @param string $event Event name (sent as X-MUDBASE-Event)
     *
     * @return self
     */
     ...
     * Sets payload
     *
     * @param object $payload JSON body POSTed to your endpoint
     *
     * @return self
     */
