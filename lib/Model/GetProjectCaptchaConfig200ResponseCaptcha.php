...
/**
 * GetProjectCaptchaConfig200ResponseCaptcha Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetProjectCaptchaConfig200ResponseCaptcha implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getProjectCaptchaConfig_200_response_captcha';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['min_score']) && ($this->container['min_score'] > 1)) {
            $invalidProperties[] = "invalid value for 'min_score', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['min_score']) && ($this->container['min_score'] < 0)) {
            $invalidProperties[] = "invalid value for 'min_score', must be bigger than or equal to 0.";
        }
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether CAPTCHA is enabled for this project
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version reCAPTCHA version (v2 or v3)
     *
     * @return self
     */
     ...
     * Sets site_key
     *
     * @param string|null $site_key Public site key for frontend integration
     *
     * @return self
     */
    ...
    {
        if (is_null($site_key)) {
            array_push($this->openAPINullablesSetToNull, 'site_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('site_key', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets min_score
     *
     * @param float|null $min_score Minimum score threshold for reCAPTCHA v3
     *
     * @return self
     */
    public function setMinScore($min_score)
    {
        ...
        if (($min_score > 1)) {
            throw new \InvalidArgumentException('invalid value for $min_score when calling GetProjectCaptchaConfig200ResponseCaptcha., must be smaller than or equal to 1.');
        }
        if (($min_score < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_score when calling GetProjectCaptchaConfig200ResponseCaptcha., must be bigger than or equal to 0.');
        }
