...
/**
 * GetComplianceSummary200ResponseCompliance Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetComplianceSummary200ResponseCompliance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getComplianceSummary_200_response_compliance';
    ...
    protected static $openAPITypes = [
        'gdpr' => '\MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceGdpr',
        'soc2' => '\MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSoc2',
        'security' => '\MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSecurity'
    ];
    ...
    {
        $this->setIfExists('gdpr', $data ?? [], null);
        $this->setIfExists('soc2', $data ?? [], null);
    ...
    */
     ...
     * Gets gdpr
     *
     * @return \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceGdpr|null
     */
    public function getGdpr()
    {
        return $this->container['gdpr'];
    }

    /**
     * Sets gdpr
     *
     * @param \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceGdpr|null $gdpr gdpr
     *
     * @return self
     */
    ...
    {
        if (is_null($gdpr)) {
            throw new \InvalidArgumentException('non-nullable gdpr cannot be null');
        }
        $this->container['gdpr'] = $gdpr;
     ...
     * Gets soc2
     *
     * @return \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSoc2|null
     */
    public function getSoc2()
    {
        return $this->container['soc2'];
    }

    /**
     * Sets soc2
     *
     * @param \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSoc2|null $soc2 soc2
     *
     * @return self
     */
    public function setSoc2($soc2)
    {
        if (is_null($soc2)) {
            throw new \InvalidArgumentException('non-nullable soc2 cannot be null');
        }
        $this->container['soc2'] = $soc2;
     ...
     * Gets security
     *
     * @return \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSecurity|null
     */
     ...
     * Sets security
     *
     * @param \MudbaseSDK\Model\GetComplianceSummary200ResponseComplianceSecurity|null $security security
     *
     * @return self
     */
