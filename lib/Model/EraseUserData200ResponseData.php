...
/**
 * EraseUserData200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class EraseUserData200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'eraseUserData_200_response_data';
    ...
    protected static $setters = [
        'already_erased' => 'setAlreadyErased',
    ...
    protected static $getters = [
        'already_erased' => 'getAlreadyErased',
    ...
    {
        $this->setIfExists('already_erased', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getAlreadyErased()
    {
        return $this->container['already_erased'];
    }

    /**
     * Sets already_erased
     *
     * @param bool|null $already_erased already_erased
     *
     * @return self
     */
    public function setAlreadyErased($already_erased)
    {
        if (is_null($already_erased)) {
            throw new \InvalidArgumentException('non-nullable already_erased cannot be null');
        }
        $this->container['already_erased'] = $already_erased;
     ...
     *
     * @param bool|null $sessions_revoked sessions_revoked
     *
     * @return self
     */
