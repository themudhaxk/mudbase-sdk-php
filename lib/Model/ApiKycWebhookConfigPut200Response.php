...
/**
 * ApiKycWebhookConfigPut200Response Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiKycWebhookConfigPut200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_kyc_webhook_config_put_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('secret_set', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['secret_set'];
    }

    /**
     * Sets secret_set
     *
     * @param bool|null $secret_set secret_set
     *
     * @return self
     */
    public function setSecretSet($secret_set)
    {
        if (is_null($secret_set)) {
            throw new \InvalidArgumentException('non-nullable secret_set cannot be null');
        }
        $this->container['secret_set'] = $secret_set;
     ...
     * Sets webhook_secret
     *
     * @param string|null $webhook_secret Only present when generateSecret was true.
     *
     * @return self
     */
