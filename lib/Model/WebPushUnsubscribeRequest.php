...
/**
 * WebPushUnsubscribeRequest Class Doc Comment
 *
 * @category Class
 * @package  MudbaseSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebPushUnsubscribeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebPushUnsubscribeRequest';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string $endpoint The push-service endpoint of the subscription to remove.
     *
     * @return self
     */
