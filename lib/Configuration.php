...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://cloud.mudbase.dev';
    ...
    {
        $report  = 'PHP SDK (MudbaseSDK) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.3.13' . PHP_EOL;
