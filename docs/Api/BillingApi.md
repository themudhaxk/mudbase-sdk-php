...
Billing and subscription management. Fiat via Flutterwave (platform subscriptions and payment processing with 7% + $0.50 split). Crypto checkout via multi-chain payment processor. Project checkout and subscription endpoints are documented here.
