...
$enable_payment_processing_request = {"accountBank":"044","accountNumber":"0123456789","country":"US","businessName":"Acme Inc","businessMobile":"+1234567890"}; // \MudbaseSDK\Model\EnablePaymentProcessingRequest
...
```php
getFeeBreakdown($org_id, $amount, $currency): \MudbaseSDK\Model\GetFeeBreakdown200Response
```
