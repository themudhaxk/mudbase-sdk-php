...
```php
executeIntegration($project_id, $integration_id, $execute_integration_request): \OpenAPI\Client\Model\TestIntegration200Response
```
...
```php
testIntegration($project_id, $integration_id, $test_integration_request): \OpenAPI\Client\Model\TestIntegration200Response
```
