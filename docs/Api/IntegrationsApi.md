...
```php
integrationsExecute($project_id, $integration_id, $integrations_execute_request): \OpenAPI\Client\Model\WalletTestWebhook200Response
```
...
[**\OpenAPI\Client\Model\WalletTestWebhook200Response**](../Model/WalletTestWebhook200Response.md)
