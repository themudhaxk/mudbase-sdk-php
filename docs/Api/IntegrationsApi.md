...
```php
createFromTemplate($project_id, $create_from_template_request): \MudbaseSDK\Model\CreateIntegration201Response
```
...
$apiInstance = new MudbaseSDK\Api\IntegrationsApi(
...
$create_from_template_request = {"templateId":"65a1b2c3d4e5f6789012345h","credentials":{"apiKey":"your_api_key","apiSecret":"your_api_secret"},"name":"My Twitter Integration"}; // \MudbaseSDK\Model\CreateFromTemplateRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_from_template_request** | [**\MudbaseSDK\Model\CreateFromTemplateRequest**](../Model/CreateFromTemplateRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\CreateIntegration201Response**](../Model/CreateIntegration201Response.md)
...
```php
createIntegration($project_id, $create_integration_request): \MudbaseSDK\Model\CreateIntegration201Response
```
...
$project_id = 'project_id_example'; // string
$create_integration_request = {"name":"Twitter Integration","provider":"twitter","config":{},"credentials":{"apiKey":"your_api_key","apiSecret":"your_api_secret"}}; // \MudbaseSDK\Model\CreateIntegrationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_integration_request** | [**\MudbaseSDK\Model\CreateIntegrationRequest**](../Model/CreateIntegrationRequest.md)|  | |
...
```php
deleteIntegration($project_id, $integration_id): \MudbaseSDK\Model\MessageResponse
```
...
```php
executeIntegration($project_id, $integration_id, $execute_integration_request): \MudbaseSDK\Model\TestIntegration200Response
```
...
$project_id = 'project_id_example'; // string
$integration_id = 'integration_id_example'; // string
$execute_integration_request = {"endpoint":"/api/v1/users","method":"GET","params":{},"body":{}}; // \MudbaseSDK\Model\ExecuteIntegrationRequest
...
| **project_id** | **string**|  | |
| **integration_id** | **string**|  | |
| **execute_integration_request** | [**\MudbaseSDK\Model\ExecuteIntegrationRequest**](../Model/ExecuteIntegrationRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\TestIntegration200Response**](../Model/TestIntegration200Response.md)
...
```php
exportIntegration($project_id, $integration_id): \MudbaseSDK\Model\CreateIntegration201Response
```
...
```php
getIntegration($project_id, $integration_id): \MudbaseSDK\Model\GetIntegration200Response
```
...
[**\MudbaseSDK\Model\GetIntegration200Response**](../Model/GetIntegration200Response.md)
...
```php
getIntegrations($project_id): \MudbaseSDK\Model\GetIntegrations200Response
```
...
[**\MudbaseSDK\Model\GetIntegrations200Response**](../Model/GetIntegrations200Response.md)
...
```php
getTemplates(): \MudbaseSDK\Model\GetTemplates200Response
```
...
[**\MudbaseSDK\Model\GetTemplates200Response**](../Model/GetTemplates200Response.md)
...
```php
getUsageStats($project_id, $integration_id, $period): \MudbaseSDK\Model\GetUsageStats200Response
```
...
[**\MudbaseSDK\Model\GetUsageStats200Response**](../Model/GetUsageStats200Response.md)
...
```php
importIntegration($project_id, $import_integration_request): \MudbaseSDK\Model\CreateIntegration201Response
```
...
$project_id = 'project_id_example'; // string
$import_integration_request = {"integrationData":{"name":"Imported Integration","provider":"custom","config":{},"credentials":{}}}; // \MudbaseSDK\Model\ImportIntegrationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **import_integration_request** | [**\MudbaseSDK\Model\ImportIntegrationRequest**](../Model/ImportIntegrationRequest.md)|  | |
...
```php
testIntegration($project_id, $integration_id, $test_integration_request): \MudbaseSDK\Model\TestIntegration200Response
```
...
$project_id = 'project_id_example'; // string
$integration_id = 'integration_id_example'; // string
$test_integration_request = {"endpoint":"/api/v1/test","method":"GET","params":{}}; // \MudbaseSDK\Model\TestIntegrationRequest
...
| **project_id** | **string**|  | |
| **integration_id** | **string**|  | |
| **test_integration_request** | [**\MudbaseSDK\Model\TestIntegrationRequest**](../Model/TestIntegrationRequest.md)|  | |
...
```php
updateIntegration($project_id, $integration_id, $update_integration_request): \MudbaseSDK\Model\CreateIntegration201Response
```
...
$project_id = 'project_id_example'; // string
$integration_id = 'integration_id_example'; // string
$update_integration_request = {"name":"Updated Integration","config":{},"credentials":{"apiKey":"updated_api_key"}}; // \MudbaseSDK\Model\UpdateIntegrationRequest
...
| **project_id** | **string**|  | |
| **integration_id** | **string**|  | |
| **update_integration_request** | [**\MudbaseSDK\Model\UpdateIntegrationRequest**](../Model/UpdateIntegrationRequest.md)|  | |
