...
```php
assignRole($org_id, $user_id, $assign_role_request): \OpenAPI\Client\Model\AssignRole200Response
```
...
$assign_role_request = {"roleSlug":"support_agent"}; // \OpenAPI\Client\Model\AssignRoleRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **assign_role_request** | [**\OpenAPI\Client\Model\AssignRoleRequest**](../Model/AssignRoleRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\AssignRole200Response**](../Model/AssignRole200Response.md)
...
```php
checkPermissions($org_id, $user_id): \OpenAPI\Client\Model\CheckPermissions200Response
```
...
[**\OpenAPI\Client\Model\CheckPermissions200Response**](../Model/CheckPermissions200Response.md)
...
```php
createRole($org_id, $create_role_request): \OpenAPI\Client\Model\CreateRole201Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$create_role_request = {"name":"Support Agent","description":"Customer support team member","hierarchy":40,"collectionPermissions":{"users":["create","read","update"],"products":["read"],"orders":{"actions":["create","read"],"conditions":{"status":"active"}}}}; // \OpenAPI\Client\Model\CreateRoleRequest
...
[**\OpenAPI\Client\Model\CreateRole201Response**](../Model/CreateRole201Response.md)
...
```php
deleteRole($org_id, $role_id): \OpenAPI\Client\Model\DeleteRole200Response
```
...
```php
getRole($org_id, $role_id): \OpenAPI\Client\Model\GetRole200Response
```
...
[**\OpenAPI\Client\Model\GetRole200Response**](../Model/GetRole200Response.md)
...
```php
getUsersByRole($org_id, $role_slug): \OpenAPI\Client\Model\GetUsersByRole200Response
```
...
[**\OpenAPI\Client\Model\GetUsersByRole200Response**](../Model/GetUsersByRole200Response.md)
...
```php
listRoles($org_id): \OpenAPI\Client\Model\ListRoles200Response
```
...
[**\OpenAPI\Client\Model\ListRoles200Response**](../Model/ListRoles200Response.md)
...
```php
removeRole($org_id, $user_id): \OpenAPI\Client\Model\AssignRole200Response
```
...
```php
updateRole($org_id, $role_id, $update_role_request): \OpenAPI\Client\Model\UpdateRole200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$role_id = role123; // string
$update_role_request = {"name":"Support Agent","description":"Customer support team member with enhanced permissions","hierarchy":45,"isActive":true,"permissions":[{"resource":"data","actions":["read","update","delete"],"conditions":{"collection":["orders","customers","tickets"]}}]}; // \OpenAPI\Client\Model\UpdateRoleRequest
