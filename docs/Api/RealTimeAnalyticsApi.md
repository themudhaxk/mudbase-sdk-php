...
```php
checkUserPresence($project_id, $check_user_presence_request): \OpenAPI\Client\Model\CheckUserPresence200Response
```
...
$check_user_presence_request = {"userIds":["685acbe0e129932fbb7a0fc2","685acbe0e129932fbb7a0fc3"]}; // \OpenAPI\Client\Model\CheckUserPresenceRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **check_user_presence_request** | [**\OpenAPI\Client\Model\CheckUserPresenceRequest**](../Model/CheckUserPresenceRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\CheckUserPresence200Response**](../Model/CheckUserPresence200Response.md)
...
```php
getActiveUsers($project_id): \OpenAPI\Client\Model\GetActiveUsers200Response
```
...
[**\OpenAPI\Client\Model\GetActiveUsers200Response**](../Model/GetActiveUsers200Response.md)
...
```php
getEventThroughput($project_id, $window): \OpenAPI\Client\Model\GetEventThroughput200Response
```
...
[**\OpenAPI\Client\Model\GetEventThroughput200Response**](../Model/GetEventThroughput200Response.md)
...
```php
getGlobalAnalytics(): \OpenAPI\Client\Model\GetGlobalAnalytics200Response
```
...
[**\OpenAPI\Client\Model\GetGlobalAnalytics200Response**](../Model/GetGlobalAnalytics200Response.md)
...
```php
getHistoricalAnalytics($project_id, $period): \OpenAPI\Client\Model\GetHistoricalAnalytics200Response
```
...
[**\OpenAPI\Client\Model\GetHistoricalAnalytics200Response**](../Model/GetHistoricalAnalytics200Response.md)
...
```php
getProjectAnalytics($project_id): \OpenAPI\Client\Model\GetProjectAnalytics200Response
```
...
[**\OpenAPI\Client\Model\GetProjectAnalytics200Response**](../Model/GetProjectAnalytics200Response.md)
