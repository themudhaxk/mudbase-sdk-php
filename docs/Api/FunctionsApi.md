...
```php
activateFunction($project_id, $function_id): \OpenAPI\Client\Model\FunctionResponse
```
...
```php
createFunction($project_id, $create_function_request): \OpenAPI\Client\Model\FunctionResponse
```
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_function_request** | [**\OpenAPI\Client\Model\CreateFunctionRequest**](../Model/CreateFunctionRequest.md)|  | |
...
```php
deactivateFunction($project_id, $function_id): \OpenAPI\Client\Model\FunctionResponse
```
...
```php
deleteFunction($project_id, $function_id): \OpenAPI\Client\Model\DeleteFunction200Response
```
...
```php
executeFunction($project_id, $function_id, $execute_function_request): \OpenAPI\Client\Model\FunctionExecutionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$execute_function_request = {"payload":{"userId":"685acbe0e129932fbb7a0fc2","action":"process"}}; // \OpenAPI\Client\Model\ExecuteFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **execute_function_request** | [**\OpenAPI\Client\Model\ExecuteFunctionRequest**](../Model/ExecuteFunctionRequest.md)|  | [optional] |
...
```php
getFunction($project_id, $function_id): \OpenAPI\Client\Model\FunctionResponse
```
...
```php
getFunctionExecution($project_id, $function_id, $execution_id): \OpenAPI\Client\Model\FunctionExecutionStatusResponse
```
...
[**\OpenAPI\Client\Model\FunctionExecutionStatusResponse**](../Model/FunctionExecutionStatusResponse.md)
...
```php
getFunctionLogs($project_id, $function_id, $limit, $offset): \OpenAPI\Client\Model\FunctionLogsResponse
```
...
```php
getFunctionVersions($project_id, $function_id): \OpenAPI\Client\Model\GetFunctionVersions200Response
```
...
[**\OpenAPI\Client\Model\GetFunctionVersions200Response**](../Model/GetFunctionVersions200Response.md)
...
```php
listFunctions($project_id, $page, $limit, $search, $trigger_type, $is_active): \OpenAPI\Client\Model\FunctionListResponse
```
...
```php
retryFunctionExecution($project_id, $function_id, $execution_index): \OpenAPI\Client\Model\FunctionExecutionResponse
```
...
```php
rollbackFunction($project_id, $function_id, $rollback_function_request): \OpenAPI\Client\Model\FunctionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$rollback_function_request = {"version":2}; // \OpenAPI\Client\Model\RollbackFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **rollback_function_request** | [**\OpenAPI\Client\Model\RollbackFunctionRequest**](../Model/RollbackFunctionRequest.md)|  | |
...
```php
simulateFunctionTrigger($project_id, $function_id, $simulate_function_trigger_request): \OpenAPI\Client\Model\FunctionExecutionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$simulate_function_trigger_request = {"trigger":{"type":"document","event":"create"},"eventContext":{"document":{"_id":"685ae1210136e73fa1dcaf36","collectionId":"685ada8fd9416ac02f171abf","data":{"name":"John","email":"john@example.com"}}}}; // \OpenAPI\Client\Model\SimulateFunctionTriggerRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **simulate_function_trigger_request** | [**\OpenAPI\Client\Model\SimulateFunctionTriggerRequest**](../Model/SimulateFunctionTriggerRequest.md)|  | [optional] |
...
```php
triggerFunctionWebhook($project_id, $x_webhook_secret, $body): \OpenAPI\Client\Model\TriggerFunctionWebhook200Response
```
...
[**\OpenAPI\Client\Model\TriggerFunctionWebhook200Response**](../Model/TriggerFunctionWebhook200Response.md)
...
```php
updateFunction($project_id, $function_id, $update_function_request): \OpenAPI\Client\Model\FunctionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$update_function_request = {"name":"OnUserCreate v2","code":"return { version: 2 };\n","versionComment":"Add version tracking"}; // \OpenAPI\Client\Model\UpdateFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **update_function_request** | [**\OpenAPI\Client\Model\UpdateFunctionRequest**](../Model/UpdateFunctionRequest.md)|  | [optional] |
