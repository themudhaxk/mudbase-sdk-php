...
```php
getProjectVapidPublicKey($project_id): \OpenAPI\Client\Model\WebPushPublicKeyResponse
```
...
[**\OpenAPI\Client\Model\WebPushPublicKeyResponse**](../Model/WebPushPublicKeyResponse.md)
...
```php
getProjectWebPushConfig($project_id): \OpenAPI\Client\Model\WebPushConfigResponse
```
...
[**\OpenAPI\Client\Model\WebPushConfigResponse**](../Model/WebPushConfigResponse.md)
...
```php
listWebPushSubscriptions($project_id): \OpenAPI\Client\Model\WebPushSubscriptionListResponse
```
...
[**\OpenAPI\Client\Model\WebPushSubscriptionListResponse**](../Model/WebPushSubscriptionListResponse.md)
...
```php
patchProjectWebPushConfig($project_id, $web_push_config_patch_request): \OpenAPI\Client\Model\WebPushConfigResponse
```
...
$project_id = 'project_id_example'; // string
$web_push_config_patch_request = {"enabled":true,"subject":"mailto:push@yourapp.com"}; // \OpenAPI\Client\Model\WebPushConfigPatchRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **web_push_config_patch_request** | [**\OpenAPI\Client\Model\WebPushConfigPatchRequest**](../Model/WebPushConfigPatchRequest.md)|  | |
...
```php
registerWebPushSubscription($project_id, $web_push_subscribe_request): \OpenAPI\Client\Model\WebPushSubscribeResponse
```
...
$project_id = 'project_id_example'; // string
$web_push_subscribe_request = {"subscription":{"endpoint":"https://push-service.example.com/subscribe/abc123","keys":{"p256dh":"BEexample-p256dh-key-base64url","auth":"example-auth-secret-base64url"}},"userId":"user_123"}; // \OpenAPI\Client\Model\WebPushSubscribeRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **web_push_subscribe_request** | [**\OpenAPI\Client\Model\WebPushSubscribeRequest**](../Model/WebPushSubscribeRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\WebPushSubscribeResponse**](../Model/WebPushSubscribeResponse.md)
...
```php
removeWebPushSubscription($project_id, $web_push_unsubscribe_request): \OpenAPI\Client\Model\WebPushUnsubscribeResponse
```
...
$project_id = 'project_id_example'; // string
$web_push_unsubscribe_request = {"endpoint":"https://push-service.example.com/subscribe/abc123"}; // \OpenAPI\Client\Model\WebPushUnsubscribeRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **web_push_unsubscribe_request** | [**\OpenAPI\Client\Model\WebPushUnsubscribeRequest**](../Model/WebPushUnsubscribeRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\WebPushUnsubscribeResponse**](../Model/WebPushUnsubscribeResponse.md)
...
```php
sendPushNotification($project_id, $push_notification_request): \OpenAPI\Client\Model\PushSentResponse
```
...
[**\OpenAPI\Client\Model\PushSentResponse**](../Model/PushSentResponse.md)
