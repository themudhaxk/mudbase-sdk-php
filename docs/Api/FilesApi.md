...
```php
apiFilesDownloadFileIdGet($file_id, $expires_in): \MudbaseSDK\Model\ApiFilesDownloadFileIdGet200Response
```
...
$apiInstance = new MudbaseSDK\Api\FilesApi(
...
[**\MudbaseSDK\Model\ApiFilesDownloadFileIdGet200Response**](../Model/ApiFilesDownloadFileIdGet200Response.md)
...
```php
confirmDirectUpload($confirm_direct_upload_request): \MudbaseSDK\Model\ConfirmUploadResponse
```
...
$confirm_direct_upload_request = {"key":"65a1b2c3d4e5f6789012345a/default/abcd-1234-invoice.pdf","projectId":"65a1b2c3d4e5f6789012345a","originalName":"invoice.pdf","contentType":"application/pdf","size":52312,"isPublic":false}; // \MudbaseSDK\Model\ConfirmDirectUploadRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **confirm_direct_upload_request** | [**\MudbaseSDK\Model\ConfirmDirectUploadRequest**](../Model/ConfirmDirectUploadRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\ConfirmUploadResponse**](../Model/ConfirmUploadResponse.md)
...
```php
deleteFile($project_id, $bucket_id, $file_id): \MudbaseSDK\Model\MessageResponse
```
...
```php
downloadFile($file_id, $token): \MudbaseSDK\Model\SignedUrlResponse
```
...
[**\MudbaseSDK\Model\SignedUrlResponse**](../Model/SignedUrlResponse.md)
...
```php
generatePresignedUpload($generate_presigned_upload_request): \MudbaseSDK\Model\PresignedPostResponse
```
...
$generate_presigned_upload_request = {"projectId":"65a1b2c3d4e5f6789012345a","bucket":"default","originalName":"invoice.pdf","contentType":"application/pdf","isPublic":false}; // \MudbaseSDK\Model\GeneratePresignedUploadRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_presigned_upload_request** | [**\MudbaseSDK\Model\GeneratePresignedUploadRequest**](../Model/GeneratePresignedUploadRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\PresignedPostResponse**](../Model/PresignedPostResponse.md)
...
```php
generateSignedUrl($project_id, $bucket_id, $file_id, $generate_signed_url_request): \MudbaseSDK\Model\SignedUrlResponse
```
...
$bucket_id = 'bucket_id_example'; // string
$file_id = 'file_id_example'; // string
$generate_signed_url_request = {"expiresIn":3600}; // \MudbaseSDK\Model\GenerateSignedUrlRequest
...
| **bucket_id** | **string**|  | |
| **file_id** | **string**|  | |
| **generate_signed_url_request** | [**\MudbaseSDK\Model\GenerateSignedUrlRequest**](../Model/GenerateSignedUrlRequest.md)|  | [optional] |
...
```php
getFile($project_id, $bucket_id, $file_id): \MudbaseSDK\Model\FileResponse
```
...
[**\MudbaseSDK\Model\FileResponse**](../Model/FileResponse.md)
...
```php
listFiles($project_id, $bucket_id, $page, $limit, $search, $type): \MudbaseSDK\Model\FileListResponse
```
...
[**\MudbaseSDK\Model\FileListResponse**](../Model/FileListResponse.md)
...
```php
uploadFiles($project_id, $bucket_id, $files): \MudbaseSDK\Model\FileUploadResponse
```
...
[**\MudbaseSDK\Model\FileUploadResponse**](../Model/FileUploadResponse.md)
