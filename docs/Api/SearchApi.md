...
```php
getSearchAnalytics($project_id, $timeframe): \MudbaseSDK\Model\GetSearchAnalytics200Response
```
...
$apiInstance = new MudbaseSDK\Api\SearchApi(
...
[**\MudbaseSDK\Model\GetSearchAnalytics200Response**](../Model/GetSearchAnalytics200Response.md)
...
```php
getSearchSuggestions($project_id, $q, $limit): \MudbaseSDK\Model\GetSearchSuggestions200Response
```
...
[**\MudbaseSDK\Model\GetSearchSuggestions200Response**](../Model/GetSearchSuggestions200Response.md)
...
```php
searchData($project_id, $q, $collections, $fields, $limit, $page): \MudbaseSDK\Model\SearchResponse
```
...
[**\MudbaseSDK\Model\SearchResponse**](../Model/SearchResponse.md)
