...
$auth_resend_verification_request = new \OpenAPI\Client\Model\AuthResendVerificationRequest(); // \OpenAPI\Client\Model\AuthResendVerificationRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **auth_resend_verification_request** | [**\OpenAPI\Client\Model\AuthResendVerificationRequest**](../Model/AuthResendVerificationRequest.md)|  | |
...
$auth_verify_email_request = new \OpenAPI\Client\Model\AuthVerifyEmailRequest(); // \OpenAPI\Client\Model\AuthVerifyEmailRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **auth_verify_email_request** | [**\OpenAPI\Client\Model\AuthVerifyEmailRequest**](../Model/AuthVerifyEmailRequest.md)|  | |
