...
```php
mcpConfigGet(): \MudbaseSDK\Model\McpConfigGet200Response
```
...
$apiInstance = new MudbaseSDK\Api\MCPApi(
...
[**\MudbaseSDK\Model\McpConfigGet200Response**](../Model/McpConfigGet200Response.md)
