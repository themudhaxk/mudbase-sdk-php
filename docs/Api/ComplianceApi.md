...
```php
apiGdprErasePost($api_gdpr_erase_post_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
...
$apiInstance = new MudbaseSDK\Api\ComplianceApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$api_gdpr_erase_post_request = new \MudbaseSDK\Model\ApiGdprErasePostRequest(); // \MudbaseSDK\Model\ApiGdprErasePostRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **api_gdpr_erase_post_request** | [**\MudbaseSDK\Model\ApiGdprErasePostRequest**](../Model/ApiGdprErasePostRequest.md)|  | |
...
```php
generateAccessReview($generate_access_review_request): \MudbaseSDK\Model\GenerateAccessReview200Response
```
...
$generate_access_review_request = {"orgId":"685acbe0e129932fbb7a0fc3","reviewPeriod":{"start":"2024-10-01T00:00:00.000Z","end":"2024-12-31T23:59:59.000Z"}}; // \MudbaseSDK\Model\GenerateAccessReviewRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_access_review_request** | [**\MudbaseSDK\Model\GenerateAccessReviewRequest**](../Model/GenerateAccessReviewRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\GenerateAccessReview200Response**](../Model/GenerateAccessReview200Response.md)
...
```php
generateDataProcessingRecord($generate_data_processing_record_request): \MudbaseSDK\Model\GenerateDataProcessingRecord200Response
```
...
$generate_data_processing_record_request = {"orgId":"685acbe0e129932fbb7a0fc3","recordDate":"2024-12-16T00:00:00.000Z"}; // \MudbaseSDK\Model\GenerateDataProcessingRecordRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_data_processing_record_request** | [**\MudbaseSDK\Model\GenerateDataProcessingRecordRequest**](../Model/GenerateDataProcessingRecordRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\GenerateDataProcessingRecord200Response**](../Model/GenerateDataProcessingRecord200Response.md)
...
```php
getComplianceSummary(): \MudbaseSDK\Model\GetComplianceSummary200Response
```
...
[**\MudbaseSDK\Model\GetComplianceSummary200Response**](../Model/GetComplianceSummary200Response.md)
...
```php
logSecurityEvent($log_security_event_request): \MudbaseSDK\Model\LogSecurityEvent200Response
```
...
$log_security_event_request = {"eventType":"unauthorized_access_attempt","severity":"high","details":{"userId":"685acbe0e129932fbb7a0fc2","resource":"admin-panel","ipAddress":"192.168.1.100","action":"blocked","reason":"Insufficient permissions"}}; // \MudbaseSDK\Model\LogSecurityEventRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **log_security_event_request** | [**\MudbaseSDK\Model\LogSecurityEventRequest**](../Model/LogSecurityEventRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\LogSecurityEvent200Response**](../Model/LogSecurityEvent200Response.md)
