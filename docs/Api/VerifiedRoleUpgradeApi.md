...
```php
verifiedRoleUpgrade($org_id, $user_id, $verified_role_upgrade_request): \MudbaseSDK\Model\VerifiedRoleUpgrade200Response
```
...
$apiInstance = new MudbaseSDK\Api\VerifiedRoleUpgradeApi(
...
$verified_role_upgrade_request = {"targetRole":"seller","paymentIntentId":"pi_abc123","verificationId":"kyc_xyz789"}; // \MudbaseSDK\Model\VerifiedRoleUpgradeRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **verified_role_upgrade_request** | [**\MudbaseSDK\Model\VerifiedRoleUpgradeRequest**](../Model/VerifiedRoleUpgradeRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\VerifiedRoleUpgrade200Response**](../Model/VerifiedRoleUpgrade200Response.md)
