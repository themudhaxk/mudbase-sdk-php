...
```php
createBackup($project_id, $create_backup_request): \MudbaseSDK\Model\CreateBackup201Response
```
...
$apiInstance = new MudbaseSDK\Api\BackupsApi(
...
$create_backup_request = {"description":"Pre-deployment backup","includeFiles":true,"includeWallets":false}; // \MudbaseSDK\Model\CreateBackupRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_backup_request** | [**\MudbaseSDK\Model\CreateBackupRequest**](../Model/CreateBackupRequest.md)|  | [optional] |

### Return type

[**\MudbaseSDK\Model\CreateBackup201Response**](../Model/CreateBackup201Response.md)
...
```php
deleteBackup($project_id, $backup_id): \MudbaseSDK\Model\DeleteBackup200Response
```
...
[**\MudbaseSDK\Model\DeleteBackup200Response**](../Model/DeleteBackup200Response.md)
...
```php
listBackups($project_id): \MudbaseSDK\Model\ListBackups200Response
```
...
[**\MudbaseSDK\Model\ListBackups200Response**](../Model/ListBackups200Response.md)
...
```php
restoreBackup($project_id, $backup_id, $restore_backup_request): \MudbaseSDK\Model\RestoreBackup200Response
```
...
$project_id = 'project_id_example'; // string
$backup_id = 'backup_id_example'; // string
$restore_backup_request = {"restoreMode":"replace","collections":["products","orders"],"confirmation":"RESTORE_DATA"}; // \MudbaseSDK\Model\RestoreBackupRequest
...
| **project_id** | **string**|  | |
| **backup_id** | **string**|  | |
| **restore_backup_request** | [**\MudbaseSDK\Model\RestoreBackupRequest**](../Model/RestoreBackupRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\RestoreBackup200Response**](../Model/RestoreBackup200Response.md)
