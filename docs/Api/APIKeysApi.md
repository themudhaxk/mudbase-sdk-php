...
```php
createApiKey($create_api_key_request): \OpenAPI\Client\Model\CreateApiKey201Response
```
...
[**\OpenAPI\Client\Model\CreateApiKey201Response**](../Model/CreateApiKey201Response.md)
...
```php
deleteApiKey($id): \OpenAPI\Client\Model\MessageResponse
```
...
```php
getApiKeyUsage($id): \OpenAPI\Client\Model\ApiKeyUsageResponse
```
...
[**\OpenAPI\Client\Model\ApiKeyUsageResponse**](../Model/ApiKeyUsageResponse.md)
...
```php
listApiKeys(): \OpenAPI\Client\Model\ListApiKeys200Response
```
...
```php
regenerateApiKey($id): \OpenAPI\Client\Model\RegenerateApiKey200Response
```
...
[**\OpenAPI\Client\Model\RegenerateApiKey200Response**](../Model/RegenerateApiKey200Response.md)
...
```php
updateApiKey($id, $update_api_key_request): \OpenAPI\Client\Model\UpdateApiKey200Response
```
...
$id = 'id_example'; // string
$update_api_key_request = {"name":"Updated API Key","permissions":[{"resource":"database","actions":["read","update"]},{"resource":"storage","actions":["read"]}],"isActive":true}; // \OpenAPI\Client\Model\UpdateApiKeyRequest
...
[**\OpenAPI\Client\Model\UpdateApiKey200Response**](../Model/UpdateApiKey200Response.md)
