...
```php
usersVerifyEmail($users_verify_email_request): \OpenAPI\Client\Model\MessageResponse
```
...
$users_verify_email_request = {"token":"a1b2c3d4..."}; // \OpenAPI\Client\Model\UsersVerifyEmailRequest | Verification token from the email link; optional projectId for project context.

try {
    $result = $apiInstance->usersVerifyEmail($users_verify_email_request);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **users_verify_email_request** | [**\OpenAPI\Client\Model\UsersVerifyEmailRequest**](../Model/UsersVerifyEmailRequest.md)| Verification token from the email link; optional projectId for project context. | |
