...
```php
apiMeBootstrapGet(): \MudbaseSDK\Model\ApiMeBootstrapGet200Response
```
...
$apiInstance = new MudbaseSDK\Api\UsersApi(
...
[**\MudbaseSDK\Model\ApiMeBootstrapGet200Response**](../Model/ApiMeBootstrapGet200Response.md)
...
```php
changePassword($change_password_request): \MudbaseSDK\Model\MessageResponse
```
...
$change_password_request = {"currentPassword":"OldPassword123!","newPassword":"NewSecurePass123!"}; // \MudbaseSDK\Model\ChangePasswordRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **change_password_request** | [**\MudbaseSDK\Model\ChangePasswordRequest**](../Model/ChangePasswordRequest.md)|  | |
...
```php
disable2FA($disable2_fa_request): \MudbaseSDK\Model\MessageResponse
```
...
$disable2_fa_request = {"password":"SecurePass123!","token":"123456"}; // \MudbaseSDK\Model\Disable2FARequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **disable2_fa_request** | [**\MudbaseSDK\Model\Disable2FARequest**](../Model/Disable2FARequest.md)|  | |
...
```php
eraseUserData($erase_user_data_request): \MudbaseSDK\Model\EraseUserData200Response
```
...
$erase_user_data_request = {"confirm":"DELETE","currentPassword":"CurrentPassword123!"}; // \MudbaseSDK\Model\EraseUserDataRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **erase_user_data_request** | [**\MudbaseSDK\Model\EraseUserDataRequest**](../Model/EraseUserDataRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\EraseUserData200Response**](../Model/EraseUserData200Response.md)
...
```php
exportUserData(): \MudbaseSDK\Model\ExportUserData200Response
```
...
[**\MudbaseSDK\Model\ExportUserData200Response**](../Model/ExportUserData200Response.md)
...
```php
getCurrentUser(): \MudbaseSDK\Model\GetCurrentUser200Response
```
...
[**\MudbaseSDK\Model\GetCurrentUser200Response**](../Model/GetCurrentUser200Response.md)
...
```php
listOAuthProviders(): \MudbaseSDK\Model\ListOAuthProviders200Response
```
...
[**\MudbaseSDK\Model\ListOAuthProviders200Response**](../Model/ListOAuthProviders200Response.md)
...
```php
resendVerificationEmail(): \MudbaseSDK\Model\MessageResponse
```
...
```php
setup2FA(): \MudbaseSDK\Model\TwoFASetupResponse
```
...
[**\MudbaseSDK\Model\TwoFASetupResponse**](../Model/TwoFASetupResponse.md)
...
```php
unlinkOAuthProvider($provider): \MudbaseSDK\Model\UnlinkOAuthProvider200Response
```
...
[**\MudbaseSDK\Model\UnlinkOAuthProvider200Response**](../Model/UnlinkOAuthProvider200Response.md)
...
```php
updateUserProfile($update_user_request): \MudbaseSDK\Model\UpdateUserProfile200Response
```
...
$update_user_request = {"firstName":"John","lastName":"Doe","avatar":"https://example.com/avatar.jpg"}; // \MudbaseSDK\Model\UpdateUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_user_request** | [**\MudbaseSDK\Model\UpdateUserRequest**](../Model/UpdateUserRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\UpdateUserProfile200Response**](../Model/UpdateUserProfile200Response.md)
...
```php
verify2FA($verify2_fa_request): \MudbaseSDK\Model\MessageResponse
```
...
$verify2_fa_request = {"token":"123456"}; // \MudbaseSDK\Model\Verify2FARequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **verify2_fa_request** | [**\MudbaseSDK\Model\Verify2FARequest**](../Model/Verify2FARequest.md)|  | |
...
```php
verifyEmail($verify_email_auth_request): \MudbaseSDK\Model\MessageResponse
```
...
$verify_email_auth_request = {"token":"a1b2c3d4..."}; // \MudbaseSDK\Model\VerifyEmailAuthRequest
