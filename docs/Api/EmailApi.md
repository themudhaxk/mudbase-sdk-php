...
```php
enqueueProjectEmail($project_id, $project_email_send_request): \MudbaseSDK\Model\EnqueueProjectEmail202Response
```
...
$apiInstance = new MudbaseSDK\Api\EmailApi(
...
$project_email_send_request = {"template":"magicLink","to":"user@example.com","data":{"userName":"Alex","magicLinkUrl":"https://app.example.com/auth/verify?token=abc","expiresIn":"15 minutes"},"idempotencyKey":"proj123:magicLink:user@example.com"}; // \MudbaseSDK\Model\ProjectEmailSendRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_email_send_request** | [**\MudbaseSDK\Model\ProjectEmailSendRequest**](../Model/ProjectEmailSendRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\EnqueueProjectEmail202Response**](../Model/EnqueueProjectEmail202Response.md)
...
```php
getProjectEmailAnalytics($project_id, $from, $to): \MudbaseSDK\Model\GetProjectEmailAnalytics200Response
```
...
[**\MudbaseSDK\Model\GetProjectEmailAnalytics200Response**](../Model/GetProjectEmailAnalytics200Response.md)
...
```php
getProjectEmailSmtp($project_id): \MudbaseSDK\Model\GetProjectEmailSmtp200Response
```
...
[**\MudbaseSDK\Model\GetProjectEmailSmtp200Response**](../Model/GetProjectEmailSmtp200Response.md)
...
```php
getProjectEmailTemplate($project_id, $name): \MudbaseSDK\Model\GetProjectEmailTemplate200Response
```
...
[**\MudbaseSDK\Model\GetProjectEmailTemplate200Response**](../Model/GetProjectEmailTemplate200Response.md)
...
```php
listProjectEmailTemplates($project_id): \MudbaseSDK\Model\ListProjectEmailTemplates200Response
```
...
[**\MudbaseSDK\Model\ListProjectEmailTemplates200Response**](../Model/ListProjectEmailTemplates200Response.md)
...
```php
patchProjectEmailSmtp($project_id, $project_smtp_patch_request): \MudbaseSDK\Model\GetProjectEmailSmtp200Response
```
...
$project_id = 'project_id_example'; // string
$project_smtp_patch_request = {"enabled":true,"host":"smtp.sendgrid.net","port":587,"secure":false,"authUser":"apikey","authPass":"SG.xxxx","fromName":"Acme App","fromEmail":"noreply@mail.example.com"}; // \MudbaseSDK\Model\ProjectSmtpPatchRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_smtp_patch_request** | [**\MudbaseSDK\Model\ProjectSmtpPatchRequest**](../Model/ProjectSmtpPatchRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$name = 'name_example'; // string
$preview_project_email_template_request = {"sampleData":{}}; // \MudbaseSDK\Model\PreviewProjectEmailTemplateRequest
...
| **project_id** | **string**|  | |
| **name** | **string**|  | |
| **preview_project_email_template_request** | [**\MudbaseSDK\Model\PreviewProjectEmailTemplateRequest**](../Model/PreviewProjectEmailTemplateRequest.md)|  | [optional] |
...
```php
testProjectEmailSmtp($project_id, $project_smtp_test_request): \MudbaseSDK\Model\DeleteFunction200Response
```
...
$project_id = 'project_id_example'; // string
$project_smtp_test_request = {"to":"ops@example.com","useSaved":true}; // \MudbaseSDK\Model\ProjectSmtpTestRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_smtp_test_request** | [**\MudbaseSDK\Model\ProjectSmtpTestRequest**](../Model/ProjectSmtpTestRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$name = 'name_example'; // string
$upsert_project_email_template_request = {"subject":"subject_example","htmlBody":"htmlBody_example"}; // \MudbaseSDK\Model\UpsertProjectEmailTemplateRequest
...
| **project_id** | **string**|  | |
| **name** | **string**|  | |
| **upsert_project_email_template_request** | [**\MudbaseSDK\Model\UpsertProjectEmailTemplateRequest**](../Model/UpsertProjectEmailTemplateRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$verify_project_email_smtp_domain_request = {"domain":"domain_example","fromEmail":"fromEmail_example","persist":true}; // \MudbaseSDK\Model\VerifyProjectEmailSmtpDomainRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **verify_project_email_smtp_domain_request** | [**\MudbaseSDK\Model\VerifyProjectEmailSmtpDomainRequest**](../Model/VerifyProjectEmailSmtpDomainRequest.md)|  | [optional] |
