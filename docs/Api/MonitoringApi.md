...
$apiInstance = new OpenAPI\Client\Api\MonitoringApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_monitoring_alert_request = {"name":"name_example","condition":"condition_example","threshold":0.01,"action":"action_example","projectId":"projectId_example"}; // \OpenAPI\Client\Model\CreateMonitoringAlertRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **create_monitoring_alert_request** | [**\OpenAPI\Client\Model\CreateMonitoringAlertRequest**](../Model/CreateMonitoringAlertRequest.md)|  | |
...
```php
getMonitoringAnalytics($project_id, $period, $granularity, $days): \OpenAPI\Client\Model\MonitoringAnalyticsResponse
```
...
[**\OpenAPI\Client\Model\MonitoringAnalyticsResponse**](../Model/MonitoringAnalyticsResponse.md)
...
```php
getMonitoringLogs($page, $limit, $project_id, $user_id, $level, $start_date, $end_date, $action, $resource): \OpenAPI\Client\Model\MonitoringLogsResponse
```
...
[**\OpenAPI\Client\Model\MonitoringLogsResponse**](../Model/MonitoringLogsResponse.md)
...
```php
getMonitoringPerformance($project_id, $period): \OpenAPI\Client\Model\MonitoringPerformanceResponse
```
...
[**\OpenAPI\Client\Model\MonitoringPerformanceResponse**](../Model/MonitoringPerformanceResponse.md)
...
```php
getScannerMetrics(): \OpenAPI\Client\Model\GetScannerMetrics200Response
```
...
try {
    $result = $apiInstance->getScannerMetrics();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MonitoringApi->getScannerMetrics: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\GetScannerMetrics200Response**](../Model/GetScannerMetrics200Response.md)
