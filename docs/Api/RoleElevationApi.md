...
$project_id = 'project_id_example'; // string | Project ID.
$role_elevation_request_request = {"roleSlug":"vendor"}; // \OpenAPI\Client\Model\RoleElevationRequestRequest | Role slug to request elevation to (e.g. vendor).
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**| Project ID. | |
| **role_elevation_request_request** | [**\OpenAPI\Client\Model\RoleElevationRequestRequest**](../Model/RoleElevationRequestRequest.md)| Role slug to request elevation to (e.g. vendor). | |
...
$project_id = 'project_id_example'; // string | Project ID.
$role_elevation_upload_documents_request = {"roleSlug":"vendor","documents":[{"type":"id","url":"https://example.com/id.pdf"}]}; // \OpenAPI\Client\Model\RoleElevationUploadDocumentsRequest | Role slug and array of document objects (type, url).
