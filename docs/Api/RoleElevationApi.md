...
```php
approveRoleElevation($org_id, $request_id, $approve_role_elevation_request): \OpenAPI\Client\Model\ApproveRoleElevation200Response
```
...
$approve_role_elevation_request = {"approved":true,"reason":"All requirements met"}; // \OpenAPI\Client\Model\ApproveRoleElevationRequest
...
| **org_id** | **string**|  | |
| **request_id** | **string**|  | |
| **approve_role_elevation_request** | [**\OpenAPI\Client\Model\ApproveRoleElevationRequest**](../Model/ApproveRoleElevationRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\ApproveRoleElevation200Response**](../Model/ApproveRoleElevation200Response.md)
...
```php
getPendingRoleElevationRequests($org_id, $status, $page, $limit): \OpenAPI\Client\Model\GetPendingRoleElevationRequests200Response
```
...
[**\OpenAPI\Client\Model\GetPendingRoleElevationRequests200Response**](../Model/GetPendingRoleElevationRequests200Response.md)
...
```php
getRoleElevationStatus($project_id, $role_slug): \OpenAPI\Client\Model\GetRoleElevationStatus200Response
```
...
[**\OpenAPI\Client\Model\GetRoleElevationStatus200Response**](../Model/GetRoleElevationStatus200Response.md)
...
```php
requestRoleElevation($project_id, $request_role_elevation_request): \OpenAPI\Client\Model\RequestRoleElevation200Response
```
...
$project_id = 'project_id_example'; // string
$request_role_elevation_request = {"roleSlug":"seller"}; // \OpenAPI\Client\Model\RequestRoleElevationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **request_role_elevation_request** | [**\OpenAPI\Client\Model\RequestRoleElevationRequest**](../Model/RequestRoleElevationRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\RequestRoleElevation200Response**](../Model/RequestRoleElevation200Response.md)
...
$project_id = 'project_id_example'; // string
$upload_verification_documents_request = {"roleSlug":"seller","documents":[{"type":"id","url":"https://example.com/id.pdf"}]}; // \OpenAPI\Client\Model\UploadVerificationDocumentsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **upload_verification_documents_request** | [**\OpenAPI\Client\Model\UploadVerificationDocumentsRequest**](../Model/UploadVerificationDocumentsRequest.md)|  | |
