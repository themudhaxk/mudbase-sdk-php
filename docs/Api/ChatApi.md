...
```php
addParticipant($project_id, $chat_id, $add_participant_request): \OpenAPI\Client\Model\AddParticipant200Response
```
...
$add_participant_request = {"userId":"685acbe0e129932fbb7a0fc2","role":"member"}; // \OpenAPI\Client\Model\AddParticipantRequest
...
| **project_id** | **string**|  | |
| **chat_id** | **string**|  | |
| **add_participant_request** | [**\OpenAPI\Client\Model\AddParticipantRequest**](../Model/AddParticipantRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\AddParticipant200Response**](../Model/AddParticipant200Response.md)
...
```php
addReaction($project_id, $chat_id, $message_id, $add_reaction_request): \OpenAPI\Client\Model\AddReaction200Response
```
...
$add_reaction_request = {"emoji":"👍"}; // \OpenAPI\Client\Model\AddReactionRequest
...
| **chat_id** | **string**|  | |
| **message_id** | **string**|  | |
| **add_reaction_request** | [**\OpenAPI\Client\Model\AddReactionRequest**](../Model/AddReactionRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\AddReaction200Response**](../Model/AddReaction200Response.md)
...
```php
createChat($project_id, $create_chat_request): \OpenAPI\Client\Model\CreateChat201Response
```
...
$project_id = 'project_id_example'; // string
$create_chat_request = {"name":"Team Chat","description":"Main team communication","type":"group","participants":["685acbe0e129932fbb7a0fc2","685acbe0e129932fbb7a0fc3"],"settings":{}}; // \OpenAPI\Client\Model\CreateChatRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_chat_request** | [**\OpenAPI\Client\Model\CreateChatRequest**](../Model/CreateChatRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\CreateChat201Response**](../Model/CreateChat201Response.md)
...
```php
deleteMessage($project_id, $chat_id, $message_id): \OpenAPI\Client\Model\MessageResponse
```
...
```php
editMessage($project_id, $chat_id, $message_id, $edit_message_request): \OpenAPI\Client\Model\EditMessage200Response
```
...
$chat_id = 'chat_id_example'; // string
$message_id = 'message_id_example'; // string
$edit_message_request = {"content":"Updated message content"}; // \OpenAPI\Client\Model\EditMessageRequest
...
| **chat_id** | **string**|  | |
| **message_id** | **string**|  | |
| **edit_message_request** | [**\OpenAPI\Client\Model\EditMessageRequest**](../Model/EditMessageRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\EditMessage200Response**](../Model/EditMessage200Response.md)
...
```php
getChatDetails($project_id, $chat_id): \OpenAPI\Client\Model\GetChatDetails200Response
```
...
[**\OpenAPI\Client\Model\GetChatDetails200Response**](../Model/GetChatDetails200Response.md)
...
```php
getChatE2eeParticipantKeys($project_id, $chat_id): \OpenAPI\Client\Model\GetChatE2eeParticipantKeys200Response
```
...
[**\OpenAPI\Client\Model\GetChatE2eeParticipantKeys200Response**](../Model/GetChatE2eeParticipantKeys200Response.md)
...
```php
getChatMessages($project_id, $chat_id, $page, $limit, $before, $after): \OpenAPI\Client\Model\GetChatMessages200Response
```
...
[**\OpenAPI\Client\Model\GetChatMessages200Response**](../Model/GetChatMessages200Response.md)
...
```php
getUserChats($project_id, $page, $limit): \OpenAPI\Client\Model\GetUserChats200Response
```
...
[**\OpenAPI\Client\Model\GetUserChats200Response**](../Model/GetUserChats200Response.md)
...
```php
markMessagesAsRead($project_id, $chat_id, $mark_messages_as_read_request): \OpenAPI\Client\Model\MarkMessagesAsRead200Response
```
...
$project_id = 'project_id_example'; // string
$chat_id = 'chat_id_example'; // string
$mark_messages_as_read_request = {"messageIds":["65a1b2c3d4e5f6789012345g","65a1b2c3d4e5f6789012345h"]}; // \OpenAPI\Client\Model\MarkMessagesAsReadRequest
...
| **project_id** | **string**|  | |
| **chat_id** | **string**|  | |
| **mark_messages_as_read_request** | [**\OpenAPI\Client\Model\MarkMessagesAsReadRequest**](../Model/MarkMessagesAsReadRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\MarkMessagesAsRead200Response**](../Model/MarkMessagesAsRead200Response.md)
...
```php
putChatE2eeKey($project_id, $put_chat_e2ee_key_request): \OpenAPI\Client\Model\PutChatE2eeKey200Response
```
...
$project_id = 'project_id_example'; // string
$put_chat_e2ee_key_request = {"identityPublicKey":"identityPublicKey_example"}; // \OpenAPI\Client\Model\PutChatE2eeKeyRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **put_chat_e2ee_key_request** | [**\OpenAPI\Client\Model\PutChatE2eeKeyRequest**](../Model/PutChatE2eeKeyRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\PutChatE2eeKey200Response**](../Model/PutChatE2eeKey200Response.md)
...
```php
removeParticipant($project_id, $chat_id, $remove_participant_request): \OpenAPI\Client\Model\MessageResponse
```
...
$project_id = 'project_id_example'; // string
$chat_id = 'chat_id_example'; // string
$remove_participant_request = {"userId":"685acbe0e129932fbb7a0fc2"}; // \OpenAPI\Client\Model\RemoveParticipantRequest
...
| **project_id** | **string**|  | |
| **chat_id** | **string**|  | |
| **remove_participant_request** | [**\OpenAPI\Client\Model\RemoveParticipantRequest**](../Model/RemoveParticipantRequest.md)|  | |
...
```php
removeReaction($project_id, $chat_id, $message_id, $add_reaction_request): \OpenAPI\Client\Model\RemoveReaction200Response
```
...
[**\OpenAPI\Client\Model\RemoveReaction200Response**](../Model/RemoveReaction200Response.md)
...
```php
sendMessage($project_id, $chat_id, $send_message_request): \OpenAPI\Client\Model\SendMessage201Response
```
...
$project_id = 'project_id_example'; // string
$chat_id = 'chat_id_example'; // string
$send_message_request = {"type":"text","content":"Hello everyone!","replyTo":null,"mentions":[]}; // \OpenAPI\Client\Model\SendMessageRequest
...
[**\OpenAPI\Client\Model\SendMessage201Response**](../Model/SendMessage201Response.md)
