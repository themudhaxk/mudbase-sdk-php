...
$project_id = 'project_id_example'; // string | Project ID.
$chat_put_chat_e2ee_key_request = {"identityPublicKey":"dGVzdEtleUJhc2U2NA==","keyVersion":1}; // \OpenAPI\Client\Model\ChatPutChatE2eeKeyRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**| Project ID. | |
| **chat_put_chat_e2ee_key_request** | [**\OpenAPI\Client\Model\ChatPutChatE2eeKeyRequest**](../Model/ChatPutChatE2eeKeyRequest.md)|  | |
