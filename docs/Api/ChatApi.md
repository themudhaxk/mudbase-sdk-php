...
$chat_id = 'chat_id_example'; // string | Chat ID.
$message_id = 'message_id_example'; // string | Message ID.
$chat_edit_message_request = {"content":"Updated message content"}; // \OpenAPI\Client\Model\ChatEditMessageRequest | New plaintext content (non-E2EE messages) or new e2ee ciphertext (E2EE messages). One of content or e2ee.ciphertext is required.
...
| **chat_id** | **string**| Chat ID. | |
| **message_id** | **string**| Message ID. | |
| **chat_edit_message_request** | [**\OpenAPI\Client\Model\ChatEditMessageRequest**](../Model/ChatEditMessageRequest.md)| New plaintext content (non-E2EE messages) or new e2ee ciphertext (E2EE messages). One of content or e2ee.ciphertext is required. | |
...
```php
chatGetChatE2eeParticipantKeys($project_id, $chat_id): \OpenAPI\Client\Model\ChatGetChatE2eeParticipantKeys200Response
```
...
try {
    $result = $apiInstance->chatGetChatE2eeParticipantKeys($project_id, $chat_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ChatApi->chatGetChatE2eeParticipantKeys: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ChatGetChatE2eeParticipantKeys200Response**](../Model/ChatGetChatE2eeParticipantKeys200Response.md)
...
```php
chatPutChatE2eeKey($project_id, $chat_put_chat_e2ee_key_request): \OpenAPI\Client\Model\ChatPutChatE2eeKey200Response
```
...
$project_id = 'project_id_example'; // string | Project ID.
$chat_put_chat_e2ee_key_request = {"identityPublicKey":"dGVzdEtleUJhc2U2NA==","keyVersion":1}; // \OpenAPI\Client\Model\ChatPutChatE2eeKeyRequest | Identity public key material for E2EE chat (base64). Private keys stay on the client.

try {
    $result = $apiInstance->chatPutChatE2eeKey($project_id, $chat_put_chat_e2ee_key_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ChatApi->chatPutChatE2eeKey: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**| Project ID. | |
| **chat_put_chat_e2ee_key_request** | [**\OpenAPI\Client\Model\ChatPutChatE2eeKeyRequest**](../Model/ChatPutChatE2eeKeyRequest.md)| Identity public key material for E2EE chat (base64). Private keys stay on the client. | |

### Return type

[**\OpenAPI\Client\Model\ChatPutChatE2eeKey200Response**](../Model/ChatPutChatE2eeKey200Response.md)
...
$project_id = 'project_id_example'; // string | Project ID.
$chat_id = 'chat_id_example'; // string | Chat ID.
$chat_send_message_request = {"type":"text","content":"Hello everyone!","replyTo":null,"mentions":[]}; // \OpenAPI\Client\Model\ChatSendMessageRequest | Message type and content, or E2EE ciphertext for text messages. Plaintext requires content; E2EE requires type=text and e2ee.ciphertext (omit plaintext content).
...
| **project_id** | **string**| Project ID. | |
| **chat_id** | **string**| Chat ID. | |
| **chat_send_message_request** | [**\OpenAPI\Client\Model\ChatSendMessageRequest**](../Model/ChatSendMessageRequest.md)| Message type and content, or E2EE ciphertext for text messages. Plaintext requires content; E2EE requires type&#x3D;text and e2ee.ciphertext (omit plaintext content). | |
