...
```php
createCollection($project_id, $create_collection_request): \MudbaseSDK\Model\CreateCollection201Response
```
...
$apiInstance = new MudbaseSDK\Api\CollectionsApi(
...
$create_collection_request = {"name":"products","fields":[{"name":"title","type":"string","required":true},{"name":"price","type":"number","required":true},{"name":"description","type":"string"}]}; // \MudbaseSDK\Model\CreateCollectionRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_collection_request** | [**\MudbaseSDK\Model\CreateCollectionRequest**](../Model/CreateCollectionRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\CreateCollection201Response**](../Model/CreateCollection201Response.md)
...
```php
deleteCollection($project_id, $collection_id): \MudbaseSDK\Model\MessageResponse
```
...
```php
getCollection($project_id, $collection_id): \MudbaseSDK\Model\Collection
```
...
[**\MudbaseSDK\Model\Collection**](../Model/Collection.md)
...
```php
listCollections($project_id): \MudbaseSDK\Model\ListCollections200Response
```
...
[**\MudbaseSDK\Model\ListCollections200Response**](../Model/ListCollections200Response.md)
...
```php
updateCollection($project_id, $collection_id, $update_collection_request): \MudbaseSDK\Model\CreateCollection201Response
```
...
$project_id = 'project_id_example'; // string
$collection_id = 'collection_id_example'; // string
$update_collection_request = {"name":"products_updated","fields":[{"name":"title","type":"string","required":true},{"name":"price","type":"number","required":true}]}; // \MudbaseSDK\Model\UpdateCollectionRequest
...
| **project_id** | **string**|  | |
| **collection_id** | **string**|  | |
| **update_collection_request** | [**\MudbaseSDK\Model\UpdateCollectionRequest**](../Model/UpdateCollectionRequest.md)|  | |
