...
```php
addCustomRole($project_id, $add_custom_role_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **add_custom_role_request** | [**\MudbaseSDK\Model\AddCustomRoleRequest**](../Model/AddCustomRoleRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\ApplyRoleFeaturePreset200Response**](../Model/ApplyRoleFeaturePreset200Response.md)
...
```php
applyRoleFeaturePreset($project_id, $role_slug, $apply_role_feature_preset_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
...
$apply_role_feature_preset_request = {"preset":"admin"}; // \MudbaseSDK\Model\ApplyRoleFeaturePresetRequest
...
| **project_id** | **string**|  | |
| **role_slug** | **string**|  | |
| **apply_role_feature_preset_request** | [**\MudbaseSDK\Model\ApplyRoleFeaturePresetRequest**](../Model/ApplyRoleFeaturePresetRequest.md)|  | |
...
```php
getAvailableRoles($project_id): \MudbaseSDK\Model\GetAvailableRoles200Response
```
...
[**\MudbaseSDK\Model\GetAvailableRoles200Response**](../Model/GetAvailableRoles200Response.md)
...
```php
getMultiRoleConfig($project_id): \MudbaseSDK\Model\GetMultiRoleConfig200Response
```
...
[**\MudbaseSDK\Model\GetMultiRoleConfig200Response**](../Model/GetMultiRoleConfig200Response.md)
...
```php
getPermissionsMatrix($project_id): \MudbaseSDK\Model\GetPermissionsMatrix200Response
```
...
[**\MudbaseSDK\Model\GetPermissionsMatrix200Response**](../Model/GetPermissionsMatrix200Response.md)
...
```php
registerWithRole($role, $register_with_role_request): \MudbaseSDK\Model\RegisterWithRole201Response
```
...
$register_with_role_request = {"email":"customer@example.com","password":"SecurePass123!","firstName":"Jane","lastName":"Doe","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","agreedToTerms":true}; // \MudbaseSDK\Model\RegisterWithRoleRequest
...
| **register_with_role_request** | [**\MudbaseSDK\Model\RegisterWithRoleRequest**](../Model/RegisterWithRoleRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\RegisterWithRole201Response**](../Model/RegisterWithRole201Response.md)
...
```php
simulateAppPermissions($project_id, $simulate_app_permissions_request): \MudbaseSDK\Model\SimulateAppPermissions200Response
```
...
$project_id = 'project_id_example'; // string
$simulate_app_permissions_request = {"role":"customer","method":"POST","pathname":"/api/messaging/projects/65f1a2b3c4d5e6f7a8b9c0d1/messaging/email"}; // \MudbaseSDK\Model\SimulateAppPermissionsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **simulate_app_permissions_request** | [**\MudbaseSDK\Model\SimulateAppPermissionsRequest**](../Model/SimulateAppPermissionsRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\SimulateAppPermissions200Response**](../Model/SimulateAppPermissions200Response.md)
...
```php
toggleRole($project_id, $role_slug, $toggle_role_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
...
$toggle_role_request = {"isEnabled":true}; // \MudbaseSDK\Model\ToggleRoleRequest
...
| **toggle_role_request** | [**\MudbaseSDK\Model\ToggleRoleRequest**](../Model/ToggleRoleRequest.md)|  | |
...
```php
updateCollectionPermissions($project_id, $role_slug, $collection_id, $update_collection_permissions_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
...
$update_collection_permissions_request = {"actions":["create","read","update","delete"],"conditions":{"status":"active"},"dataScope":"own"}; // \MudbaseSDK\Model\UpdateCollectionPermissionsRequest
...
| **update_collection_permissions_request** | [**\MudbaseSDK\Model\UpdateCollectionPermissionsRequest**](../Model/UpdateCollectionPermissionsRequest.md)|  | |
...
```php
updateMultiRoleSettings($project_id, $update_multi_role_settings_request): \MudbaseSDK\Model\UpdateMultiRoleSettings200Response
```
...
$project_id = 65f1a2b3c4d5e6f7a8b9c0d1; // string
$update_multi_role_settings_request = {"isEnabled":true,"defaultRole":"customer","settings":{"allowMultipleRoles":false,"requireRoleSelection":false,"autoAssignDefault":true,"dataOwnerField":"createdBy"}}; // \MudbaseSDK\Model\UpdateMultiRoleSettingsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **update_multi_role_settings_request** | [**\MudbaseSDK\Model\UpdateMultiRoleSettingsRequest**](../Model/UpdateMultiRoleSettingsRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\UpdateMultiRoleSettings200Response**](../Model/UpdateMultiRoleSettings200Response.md)
...
```php
updateProjectRole($project_id, $role_slug, $update_project_role_request): \MudbaseSDK\Model\ApplyRoleFeaturePreset200Response
```
