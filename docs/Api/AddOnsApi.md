...
```php
apiAddonsGet(): \MudbaseSDK\Model\ApiAddonsGet200Response
```
...
$apiInstance = new MudbaseSDK\Api\AddOnsApi(
...
[**\MudbaseSDK\Model\ApiAddonsGet200Response**](../Model/ApiAddonsGet200Response.md)
...
```php
apiProjectsProjectIdAddonsAddonInvokePost($project_id, $addon, $body): \MudbaseSDK\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response
```
...
[**\MudbaseSDK\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response**](../Model/ApiProjectsProjectIdAddonsAddonInvokePost200Response.md)
...
```php
apiProjectsProjectIdAddonsJobsIdGet($project_id, $id): \MudbaseSDK\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response
```
