...
```php
multiRoleApplyRoleFeaturePreset($project_id, $role_slug, $multi_role_apply_role_feature_preset_request)
```
...
$multi_role_apply_role_feature_preset_request = new \OpenAPI\Client\Model\MultiRoleApplyRoleFeaturePresetRequest(); // \OpenAPI\Client\Model\MultiRoleApplyRoleFeaturePresetRequest | JSON body with `preset` set to `admin`, `user`, or `viewer`.

try {
    $apiInstance->multiRoleApplyRoleFeaturePreset($project_id, $role_slug, $multi_role_apply_role_feature_preset_request);
} catch (Exception $e) {
    echo 'Exception when calling MultiRoleApi->multiRoleApplyRoleFeaturePreset: ', $e->getMessage(), PHP_EOL;
}
```
...
| **multi_role_apply_role_feature_preset_request** | [**\OpenAPI\Client\Model\MultiRoleApplyRoleFeaturePresetRequest**](../Model/MultiRoleApplyRoleFeaturePresetRequest.md)| JSON body with &#x60;preset&#x60; set to &#x60;admin&#x60;, &#x60;user&#x60;, or &#x60;viewer&#x60;. | |
...
```php
multiRoleGetPermissionsMatrix($project_id): \OpenAPI\Client\Model\MultiRoleGetPermissionsMatrix200Response
```
...
try {
    $result = $apiInstance->multiRoleGetPermissionsMatrix($project_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MultiRoleApi->multiRoleGetPermissionsMatrix: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
multiRoleSimulateAppPermissions($project_id, $multi_role_simulate_app_permissions_request): object
```
...
$multi_role_simulate_app_permissions_request = {"role":"customer","method":"POST","pathname":"/api/messaging/projects/685ad30be129932fbb7a1047/messaging/email"}; // \OpenAPI\Client\Model\MultiRoleSimulateAppPermissionsRequest | Role slug plus either OpenAPI `operationId` or HTTP `method` and `pathname` to evaluate.

try {
    $result = $apiInstance->multiRoleSimulateAppPermissions($project_id, $multi_role_simulate_app_permissions_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MultiRoleApi->multiRoleSimulateAppPermissions: ', $e->getMessage(), PHP_EOL;
}
```
...
| **multi_role_simulate_app_permissions_request** | [**\OpenAPI\Client\Model\MultiRoleSimulateAppPermissionsRequest**](../Model/MultiRoleSimulateAppPermissionsRequest.md)| Role slug plus either OpenAPI &#x60;operationId&#x60; or HTTP &#x60;method&#x60; and &#x60;pathname&#x60; to evaluate. | |
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**| Project ID. | |
| **multi_role_update_settings_request** | [**\OpenAPI\Client\Model\MultiRoleUpdateSettingsRequest**](../Model/MultiRoleUpdateSettingsRequest.md)| Feature flags only — not per-role approval. Use &#x60;settings.allowMultipleRoles&#x60;, &#x60;requireRoleSelection&#x60;, &#x60;autoAssignDefault&#x60;, &#x60;dataOwnerField&#x60;. | |
