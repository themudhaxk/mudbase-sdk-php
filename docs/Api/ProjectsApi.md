...
```php
configureOAuthProvider($project_id, $provider, $configure_o_auth_provider_request): \MudbaseSDK\Model\ConfigureOAuthProvider200Response
```
...
$apiInstance = new MudbaseSDK\Api\ProjectsApi(
...
$configure_o_auth_provider_request = {"enabled":true,"clientId":"123456789-abcdefghijklmnop.apps.googleusercontent.com","clientSecret":"GOCSPX-abcdefghijklmnopqrstuvwxyz","scope":["profile","email"],"displayName":"Sign in with Google"}; // \MudbaseSDK\Model\ConfigureOAuthProviderRequest
...
| **project_id** | **string**|  | |
| **provider** | **string**|  | |
| **configure_o_auth_provider_request** | [**\MudbaseSDK\Model\ConfigureOAuthProviderRequest**](../Model/ConfigureOAuthProviderRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\ConfigureOAuthProvider200Response**](../Model/ConfigureOAuthProvider200Response.md)
...
```php
createProject($org_id, $create_project_request): \MudbaseSDK\Model\CreateProject201Response
```
...
$create_project_request = {"name":"My New Project","description":"A new project description","orgId":"685acbe0e129932fbb7a0fc3"}; // \MudbaseSDK\Model\CreateProjectRequest
...
| **create_project_request** | [**\MudbaseSDK\Model\CreateProjectRequest**](../Model/CreateProjectRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\CreateProject201Response**](../Model/CreateProject201Response.md)
...
```php
deleteProject($org_id, $id): \MudbaseSDK\Model\MessageResponse
```
...
```php
getOAuthProviderConfig($project_id, $provider): \MudbaseSDK\Model\GetOAuthProviderConfig200Response
```
...
[**\MudbaseSDK\Model\GetOAuthProviderConfig200Response**](../Model/GetOAuthProviderConfig200Response.md)
...
```php
getProject($org_id, $id): \MudbaseSDK\Model\Project
```
...
[**\MudbaseSDK\Model\Project**](../Model/Project.md)
...
```php
getProjectCaptchaConfig($org_id, $id): \MudbaseSDK\Model\GetProjectCaptchaConfig200Response
```
...
[**\MudbaseSDK\Model\GetProjectCaptchaConfig200Response**](../Model/GetProjectCaptchaConfig200Response.md)
...
```php
getProjectDashboardOverview($project_id): \MudbaseSDK\Model\ProjectDashboardOverviewResponse
```
...
[**\MudbaseSDK\Model\ProjectDashboardOverviewResponse**](../Model/ProjectDashboardOverviewResponse.md)
...
```php
getProjectOAuthProviders($project_id): \MudbaseSDK\Model\GetProjectOAuthProviders200Response
```
...
[**\MudbaseSDK\Model\GetProjectOAuthProviders200Response**](../Model/GetProjectOAuthProviders200Response.md)
...
```php
getProjectUsage($org_id, $id): \MudbaseSDK\Model\ProjectUsageResponse
```
...
[**\MudbaseSDK\Model\ProjectUsageResponse**](../Model/ProjectUsageResponse.md)
...
```php
listProjects($org_id): \MudbaseSDK\Model\ListProjects200Response
```
...
[**\MudbaseSDK\Model\ListProjects200Response**](../Model/ListProjects200Response.md)
...
```php
updateOAuthProviderConfig($project_id, $provider, $update_o_auth_provider_config_request): \MudbaseSDK\Model\ConfigureOAuthProvider200Response
```
...
$project_id = 65f1a2b3c4d5e6f7a8b9c0d1; // string
$provider = google; // string
$update_o_auth_provider_config_request = {"enabled":true,"clientId":"123456789-abcdefghijklmnop.apps.googleusercontent.com","clientSecret":"GOCSPX-abcdefghijklmnopqrstuvwxyz","scope":["profile","email"],"displayName":"Sign in with Google"}; // \MudbaseSDK\Model\UpdateOAuthProviderConfigRequest
...
| **project_id** | **string**|  | |
| **provider** | **string**|  | |
| **update_o_auth_provider_config_request** | [**\MudbaseSDK\Model\UpdateOAuthProviderConfigRequest**](../Model/UpdateOAuthProviderConfigRequest.md)|  | |
...
```php
updateProject($org_id, $id, $update_project_request): \MudbaseSDK\Model\CreateProject201Response
```
...
$org_id = 'org_id_example'; // string | Organization ID
$id = 'id_example'; // string | Project ID
$update_project_request = {"name":"Updated Project Name","description":"Updated project description","settings":{"requireEmailVerification":true,"requirePhoneVerification":false,"defaultUserAccountStatus":"active"}}; // \MudbaseSDK\Model\UpdateProjectRequest
...
| **org_id** | **string**| Organization ID | |
| **id** | **string**| Project ID | |
| **update_project_request** | [**\MudbaseSDK\Model\UpdateProjectRequest**](../Model/UpdateProjectRequest.md)|  | |
...
```php
uploadProjectLogo($id, $logo): \MudbaseSDK\Model\UploadProjectLogo200Response
```
...
[**\MudbaseSDK\Model\UploadProjectLogo200Response**](../Model/UploadProjectLogo200Response.md)
...
```php
uploadProjectLogoByOrg($org_id, $id, $logo): \MudbaseSDK\Model\UploadProjectLogo200Response
```
