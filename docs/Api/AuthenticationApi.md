...
```php
acceptInvite($accept_invite_request): \OpenAPI\Client\Model\AcceptInvite201Response
```
...
$accept_invite_request = {"token":"a1b2c3d4e5f6...","password":"SecurePass123!","firstName":"Jane","lastName":"Doe"}; // \OpenAPI\Client\Model\AcceptInviteRequest
...
[**\OpenAPI\Client\Model\AcceptInvite201Response**](../Model/AcceptInvite201Response.md)
...
```php
confirmLocalPasswordResetWithOtp($confirm_local_password_reset_with_otp_request): \OpenAPI\Client\Model\MessageResponse
```
...
$confirm_local_password_reset_with_otp_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","otp":"123456","newPassword":"NewSecurePass123!"}; // \OpenAPI\Client\Model\ConfirmLocalPasswordResetWithOtpRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **confirm_local_password_reset_with_otp_request** | [**\OpenAPI\Client\Model\ConfirmLocalPasswordResetWithOtpRequest**](../Model/ConfirmLocalPasswordResetWithOtpRequest.md)|  | |
...
```php
convertAnonymousAccount($convert_anonymous_account_request): \OpenAPI\Client\Model\ConvertAnonymousAccount200Response
```
...
$convert_anonymous_account_request = {"email":"user@example.com","password":"SecurePassword123!","firstName":"John","lastName":"Doe"}; // \OpenAPI\Client\Model\ConvertAnonymousAccountRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **convert_anonymous_account_request** | [**\OpenAPI\Client\Model\ConvertAnonymousAccountRequest**](../Model/ConvertAnonymousAccountRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\ConvertAnonymousAccount200Response**](../Model/ConvertAnonymousAccount200Response.md)
...
```php
createAnonymousSession($create_anonymous_session_request): \OpenAPI\Client\Model\CreateAnonymousSession200Response
```
...
$create_anonymous_session_request = {"projectId":"685ad30be129932fbb7a1047","deviceId":"device-uuid-123"}; // \OpenAPI\Client\Model\CreateAnonymousSessionRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_anonymous_session_request** | [**\OpenAPI\Client\Model\CreateAnonymousSessionRequest**](../Model/CreateAnonymousSessionRequest.md)|  | [optional] |

### Return type

[**\OpenAPI\Client\Model\CreateAnonymousSession200Response**](../Model/CreateAnonymousSession200Response.md)
...
```php
getAvailableOAuthProviders(): \OpenAPI\Client\Model\GetAvailableOAuthProviders200Response
```
...
[**\OpenAPI\Client\Model\GetAvailableOAuthProviders200Response**](../Model/GetAvailableOAuthProviders200Response.md)
...
```php
getCurrentSession(): \OpenAPI\Client\Model\SessionResponse
```
...
[**\OpenAPI\Client\Model\SessionResponse**](../Model/SessionResponse.md)
...
```php
getLocalSession($project_id): \OpenAPI\Client\Model\GetLocalSession200Response
```
...
[**\OpenAPI\Client\Model\GetLocalSession200Response**](../Model/GetLocalSession200Response.md)
...
```php
getOrgOAuthProviders(): \OpenAPI\Client\Model\GetOrgOAuthProviders200Response
```
...
[**\OpenAPI\Client\Model\GetOrgOAuthProviders200Response**](../Model/GetOrgOAuthProviders200Response.md)
...
```php
loginLocalUser($login_local_user_request): \OpenAPI\Client\Model\LoginLocalUser200Response
```
...
$login_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","projectId":"685ad30be129932fbb7a1047"}; // \OpenAPI\Client\Model\LoginLocalUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **login_local_user_request** | [**\OpenAPI\Client\Model\LoginLocalUserRequest**](../Model/LoginLocalUserRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\LoginLocalUser200Response**](../Model/LoginLocalUser200Response.md)
...
```php
loginUser($login_request): \OpenAPI\Client\Model\AuthResponse
```
...
$login_request = {"email":"john.doe@mudbase.dev","password":"SecurePass123!"}; // \OpenAPI\Client\Model\LoginRequest
...
```php
logoutLocalUser(): \OpenAPI\Client\Model\MessageResponse
```
...
```php
logoutUser(): \OpenAPI\Client\Model\MessageResponse
```
...
```php
refreshToken($refresh_token_request): \OpenAPI\Client\Model\RefreshToken200Response
```
...
$refresh_token_request = {"refreshToken":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."}; // \OpenAPI\Client\Model\RefreshTokenRequest
...
[**\OpenAPI\Client\Model\RefreshToken200Response**](../Model/RefreshToken200Response.md)
...
```php
registerLocalUser($register_local_user_request): \OpenAPI\Client\Model\RegisterLocalUser201Response
```
...
$register_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","firstName":"Sarah","lastName":"Chen","projectId":"685ad30be129932fbb7a1047"}; // \OpenAPI\Client\Model\RegisterLocalUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **register_local_user_request** | [**\OpenAPI\Client\Model\RegisterLocalUserRequest**](../Model/RegisterLocalUserRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\RegisterLocalUser201Response**](../Model/RegisterLocalUser201Response.md)
...
```php
registerUser($register_request): \OpenAPI\Client\Model\AuthResponse
```
...
$register_request = {"email":"john.doe@mudbase.dev","password":"SecurePass123!","firstName":"John","lastName":"Doe","orgName":"Mudbase"}; // \OpenAPI\Client\Model\RegisterRequest
...
```php
requestLocalPasswordReset($request_local_password_reset_request): \OpenAPI\Client\Model\MessageResponse
```
...
$request_local_password_reset_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047"}; // \OpenAPI\Client\Model\RequestLocalPasswordResetRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **request_local_password_reset_request** | [**\OpenAPI\Client\Model\RequestLocalPasswordResetRequest**](../Model/RequestLocalPasswordResetRequest.md)|  | |
...
```php
requestPasswordReset($request_password_reset_request): \OpenAPI\Client\Model\MessageResponse
```
...
$request_password_reset_request = {"email":"john.doe@mudbase.dev"}; // \OpenAPI\Client\Model\RequestPasswordResetRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **request_password_reset_request** | [**\OpenAPI\Client\Model\RequestPasswordResetRequest**](../Model/RequestPasswordResetRequest.md)|  | |
...
```php
resendVerificationAuth($resend_verification_auth_request): \OpenAPI\Client\Model\MessageResponse
```
...
$resend_verification_auth_request = {"email":"user@example.com"}; // \OpenAPI\Client\Model\ResendVerificationAuthRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **resend_verification_auth_request** | [**\OpenAPI\Client\Model\ResendVerificationAuthRequest**](../Model/ResendVerificationAuthRequest.md)|  | |
...
```php
resetLocalPassword($token, $reset_local_password_request): \OpenAPI\Client\Model\MessageResponse
```
...
$reset_local_password_request = {"password":"NewSecurePass123!","projectId":"685ad30be129932fbb7a1047"}; // \OpenAPI\Client\Model\ResetLocalPasswordRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **token** | **string**|  | |
| **reset_local_password_request** | [**\OpenAPI\Client\Model\ResetLocalPasswordRequest**](../Model/ResetLocalPasswordRequest.md)|  | |
...
```php
resetPassword($token, $reset_password_request): \OpenAPI\Client\Model\MessageResponse
```
...
$token = 'token_example'; // string
$reset_password_request = {"password":"NewSecurePass123!"}; // \OpenAPI\Client\Model\ResetPasswordRequest
...
```php
sendMagicLink($magic_link_request): \OpenAPI\Client\Model\MessageResponse
```
...
$magic_link_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","redirectUrl":"https://app.example.com/auth/callback"}; // \OpenAPI\Client\Model\MagicLinkRequest
...
```php
sendOTP($otp_send_request): \OpenAPI\Client\Model\MessageResponse
```
...
$otp_send_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","method":"email"}; // \OpenAPI\Client\Model\OTPSendRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **otp_send_request** | [**\OpenAPI\Client\Model\OTPSendRequest**](../Model/OTPSendRequest.md)|  | |
...
```php
validatePasswordResetToken($validate_password_reset_token_request): \OpenAPI\Client\Model\ValidatePasswordResetToken200Response
```
...
$validate_password_reset_token_request = {"token":"abc123..."}; // \OpenAPI\Client\Model\ValidatePasswordResetTokenRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **validate_password_reset_token_request** | [**\OpenAPI\Client\Model\ValidatePasswordResetTokenRequest**](../Model/ValidatePasswordResetTokenRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\ValidatePasswordResetToken200Response**](../Model/ValidatePasswordResetToken200Response.md)
...
```php
verifyEmailAuth($verify_email_auth_request): \OpenAPI\Client\Model\MessageResponse
```
...
$verify_email_auth_request = {"token":"verification-token-from-email-link"}; // \OpenAPI\Client\Model\VerifyEmailAuthRequest
...
```php
verifyMagicLink($verify_magic_link_request): \OpenAPI\Client\Model\AuthResponse
```
...
$verify_magic_link_request = {"token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InVzZXJAZXhhbXBsZS5jb20iLCJwcm9qZWN0SWQiOiI2ODVhZDMwYmUxMjk5MzJmYmI3YTEwNDciLCJpYXQiOjE3NTA3ODA4OTgsImV4cCI6MTc1MDc4NDQ5OH0.example"}; // \OpenAPI\Client\Model\VerifyMagicLinkRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **verify_magic_link_request** | [**\OpenAPI\Client\Model\VerifyMagicLinkRequest**](../Model/VerifyMagicLinkRequest.md)|  | |
...
```php
verifyOTP($otp_verify_request): \OpenAPI\Client\Model\AuthResponse
```
...
$otp_verify_request = {"identifier":"user@example.com","otp":"123456","projectId":"685ad30be129932fbb7a1047"}; // \OpenAPI\Client\Model\OTPVerifyRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **otp_verify_request** | [**\OpenAPI\Client\Model\OTPVerifyRequest**](../Model/OTPVerifyRequest.md)|  | |
