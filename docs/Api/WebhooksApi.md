...
```php
configureWebhook($project_id, $configure_webhook_request): \MudbaseSDK\Model\ConfigureWebhook200Response
```
...
$apiInstance = new MudbaseSDK\Api\WebhooksApi(
...
$configure_webhook_request = {"webhookUrl":"https://your-app.com/webhooks/mudbase","webhookSecret":"your-secret","webhookEvents":["collection.insert","collection.update","collection.delete"],"webhookVersion":"1.0","transformations":[]}; // \MudbaseSDK\Model\ConfigureWebhookRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **configure_webhook_request** | [**\MudbaseSDK\Model\ConfigureWebhookRequest**](../Model/ConfigureWebhookRequest.md)|  | [optional] |

### Return type

[**\MudbaseSDK\Model\ConfigureWebhook200Response**](../Model/ConfigureWebhook200Response.md)
...
```php
getWebhookConfig($project_id): \MudbaseSDK\Model\GetWebhookConfig200Response
```
...
[**\MudbaseSDK\Model\GetWebhookConfig200Response**](../Model/GetWebhookConfig200Response.md)
...
```php
getWebhookStats($project_id, $days): \MudbaseSDK\Model\WebhookStatsResponse
```
...
[**\MudbaseSDK\Model\WebhookStatsResponse**](../Model/WebhookStatsResponse.md)
...
```php
listProjectWebhookLogs($project_id, $page, $limit, $status, $event): \MudbaseSDK\Model\WebhookListResponse
```
...
[**\MudbaseSDK\Model\WebhookListResponse**](../Model/WebhookListResponse.md)
...
```php
listWebhooks($page, $limit, $status, $event, $project_id): \MudbaseSDK\Model\WebhookListResponse
```
...
```php
retryWebhook($webhook_id): \MudbaseSDK\Model\RetryWebhookResponse
```
...
[**\MudbaseSDK\Model\RetryWebhookResponse**](../Model/RetryWebhookResponse.md)
...
```php
testWebhookTransformation($project_id, $test_webhook_transformation_request): \MudbaseSDK\Model\TestWebhookTransformation200Response
```
...
$project_id = 'project_id_example'; // string
$test_webhook_transformation_request = {"payload":{"event":"collection.insert","data":{"name":"Test"}},"transformations":[]}; // \MudbaseSDK\Model\TestWebhookTransformationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **test_webhook_transformation_request** | [**\MudbaseSDK\Model\TestWebhookTransformationRequest**](../Model/TestWebhookTransformationRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\TestWebhookTransformation200Response**](../Model/TestWebhookTransformation200Response.md)
...
```php
triggerWebhook($trigger_webhook_request): \MudbaseSDK\Model\TriggerWebhookResponse
```
...
$trigger_webhook_request = {"projectId":"65a1b2c3d4e5f6789012345b","url":"https://your-app.com/webhooks/mudbase","event":"manual.test","payload":{"message":"Hello from Mudbase"}}; // \MudbaseSDK\Model\TriggerWebhookRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **trigger_webhook_request** | [**\MudbaseSDK\Model\TriggerWebhookRequest**](../Model/TriggerWebhookRequest.md)|  | |

### Return type

[**\MudbaseSDK\Model\TriggerWebhookResponse**](../Model/TriggerWebhookResponse.md)
