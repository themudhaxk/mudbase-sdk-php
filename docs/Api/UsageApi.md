...
```php
getOverage(): \OpenAPI\Client\Model\GetOverage200Response
```
...
[**\OpenAPI\Client\Model\GetOverage200Response**](../Model/GetOverage200Response.md)
...
```php
getProjectUsageStats($project_id, $period): \OpenAPI\Client\Model\ProjectUsageStatsResponse
```
...
```php
getProjectUsageSummary($project_id): \OpenAPI\Client\Model\ProjectUsageSummaryResponse
```
...
[**\OpenAPI\Client\Model\ProjectUsageSummaryResponse**](../Model/ProjectUsageSummaryResponse.md)
...
```php
getUsage($period, $start_date, $end_date): \OpenAPI\Client\Model\UsageStatsResponse
```
...
[**\OpenAPI\Client\Model\UsageStatsResponse**](../Model/UsageStatsResponse.md)
...
```php
getUsageTrends($days): \OpenAPI\Client\Model\UsageTrendsResponse
```
...
```php
getUsageWarnings(): \OpenAPI\Client\Model\GetUsageWarnings200Response
```
...
[**\OpenAPI\Client\Model\GetUsageWarnings200Response**](../Model/GetUsageWarnings200Response.md)
