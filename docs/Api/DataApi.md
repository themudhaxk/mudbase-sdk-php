...
```php
createData($project_id, $collection_id, $body): \MudbaseSDK\Model\DataResponse
```
...
$apiInstance = new MudbaseSDK\Api\DataApi(
...
[**\MudbaseSDK\Model\DataResponse**](../Model/DataResponse.md)
...
```php
deleteData($project_id, $collection_id, $document_id): \MudbaseSDK\Model\MessageResponse
```
...
```php
getData($project_id, $collection_id, $document_id): \MudbaseSDK\Model\DataResponse
```
...
```php
listData($project_id, $collection_id, $page, $limit, $sort, $filter): \MudbaseSDK\Model\DataListResponse
```
...
[**\MudbaseSDK\Model\DataListResponse**](../Model/DataListResponse.md)
...
```php
updateData($project_id, $collection_id, $document_id, $body): \MudbaseSDK\Model\DataResponse
```
