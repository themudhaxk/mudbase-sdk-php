...
**dns_records** | [**\OpenAPI\Client\Model\OrgDnsRecord[]**](OrgDnsRecord.md) |  | [optional]
**platform_activation_pending** | **bool** |  | [optional]
**custom_domain_live_for_api_traffic** | **bool** |  | [optional]
**cloudflare_edge** | [**\OpenAPI\Client\Model\OrgCloudflareEdgeHints**](OrgCloudflareEdgeHints.md) |  | [optional]
