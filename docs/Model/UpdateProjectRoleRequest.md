...
**collection_permissions** | [**array<string,\OpenAPI\Client\Model\CreateRoleRequestCollectionPermissionsValue>**](CreateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (same as POST add role). | [optional]
